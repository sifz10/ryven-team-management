...
<div class="space-y-6 pb-8">
    <!-- Header -->
    <div class="mb-8">
        <a href="{{ route('admin.chatbot.index') }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300 mb-4 inline-flex items-center gap-2">
  ...
  "last_login": "2024-01-10"
            ...
            <div class="space-y-3">
                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded p-4">
                    <div class="flex items-start justify-between">
                        <div>
                            <h3 class="font-semibold text-gray-900 dark:text-white">{{ $widget->name }}</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Domain: {{ $widget->domain }}</p>
                        ...
                        <span class="px-3 py-1 rounded-full text-xs font-semibold {{ $widget->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
    ...
    <div class="bg-gradient-to-r from-blue-500 to-blue-600 dark:from-blue-700 dark:to-blue-800 rounded-lg shadow p-8 text-white">
        ...
        <div class="flex gap-3">
            <a href="{{ route('admin.chatbot.index') }}" class="bg-white text-blue-600 px-6 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                View Conversations
            </a>
            <a href="{{ config('app.url') }}/public/chatbot-demo.html" target="_blank" class="border-2 border-white text-white px-6 py-2 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors">
                View Demo
            </a>
        </div>
    </div>
