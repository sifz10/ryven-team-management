        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8 text-center">
            ...
            <div class="bg-gray-50 rounded-xl p-6 mb-6 border border-gray-200">
                ...
                <div class="text-sm text-gray-600 space-y-2">
                    ...
                    <p><strong>Submitted on:</strong> {{ $test->submitted_at->format('F j, Y \a\t g:i A') }}</p>
                    ...
                    @if($test->submission_original_name)
                        <p><strong>File:</strong> {{ $test->submission_original_name }}</p>
                    @endif
                </div>
            </div>
            ...
            @if($test->submission_notes)
                <div class="bg-blue-50 rounded-xl p-4 mb-6 text-left border border-blue-200">
                    ...
                    <p class="text-sm text-blue-800 whitespace-pre-wrap">{{ $test->submission_notes }}</p>
                </div>
            @endif
