                            ...
                            <div class="mt-2">
                                ...
                                <div class="mt-3 flex items-center gap-3">
                                    @if($log->pr_state)
                                        ...
                                        @endif
                                    @endif
                                    <a href="{{ route('github.pr.details', $log) }}" class="inline-flex items-center gap-2 px-4 py-1.5 bg-black text-white rounded-full shadow hover:bg-gray-800 transition-all font-medium text-xs">
