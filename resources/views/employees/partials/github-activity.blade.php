            ...
            <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl p-5 border border-gray-200 dark:border-gray-600">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-3xl font-bold text-gray-900 dark:text-white mt-2">{{ $totalActivities }}</div>
                    </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 rounded-xl p-5 border border-blue-200 dark:border-blue-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-3xl font-bold text-blue-900 dark:text-blue-200 mt-2">{{ $totalCommits }}</div>
                    </div>
            ...
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 rounded-xl p-5 border border-purple-200 dark:border-purple-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-3xl font-bold text-purple-900 dark:text-purple-200 mt-2">{{ $prCount }}</div>
                    </div>
            ...
            <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 rounded-xl p-5 border border-green-200 dark:border-green-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-3xl font-bold text-green-900 dark:text-green-200 mt-2">{{ $repositories->count() }}</div>
                    </div>
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm overflow-hidden">
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <span class="font-medium text-gray-900 dark:text-white" id="total-activities">{{ $totalActivities }}</span> activities
                    </div>
            </div>
        </div>
        ...
        <div id="activities-container">
            @forelse($githubLogs as $log)
                @include('employees.partials.github-activity-item', ['githubLogs' => collect([$log]), 'employee' => $employee])
            @empty
                <div class="p-12">
                            ...
                            <div class="flex items-start gap-3 mb-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <ol class="list-decimal list-inside space-y-2 mb-4 text-sm text-gray-700 dark:text-gray-300">
                                        ...
                                        <li>Add a new webhook with URL: <code class="px-2 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs">{{ url('/webhook/github') }}</code></li>
                                    ...
                                    <ul class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                                        ...
                                        @else
                                            <li class="flex items-center gap-2">
                                                ...
                                                <span>Add GitHub username in <a href="{{ route('employees.edit', $employee) }}" class="underline font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300">employee settings</a></span>
                                            </li>
                                        @endif
                                        <li class="flex items-center gap-2">
                                            <span class="text-blue-600 dark:text-blue-400">•</span>
                                            Email matching: <code class="px-2 py-0.5 bg-gray-100 dark:bg-gray-700 rounded text-xs">{{ $employee->email }}</code>
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
const GitHubActivities = {
    ...
    currentPage: 1,
    hasMore: {{ $githubLogs->count() >= 15 ? 'true' : 'false' }},
    loading: false,
    polling: false,
    pollInterval: null,
