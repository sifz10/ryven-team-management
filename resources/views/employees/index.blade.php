                ...
                @forelse ($employees as $employee)
                    ...
                    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 group">
                        ...
                        <div class="px-4 pb-4 flex items-center gap-2">
                            ...
                            <form method="POST" action="{{ route('employees.destroy', $employee) }}" id="delete-form-{{ $employee->id }}" class="inline">
                                @csrf
                                @method('DELETE')
                                <button type="button"
                                        @click="$dispatch('open-delete-modal', { id: 'deleteModal', form: document.getElementById('delete-form-{{ $employee->id }}') })"
