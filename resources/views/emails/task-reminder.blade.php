...
<body>
    <div class="container">
        ...
        <p>Hello {{ $recipient ? ($reminder->recipient_type === 'employee' ? $recipient->first_name . ' ' . $recipient->last_name : $recipient->name) : 'there' }},</p>
        ...
        <div class="task-details">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">{{ \Carbon\Carbon::parse($task->due_date)->format('F j, Y') }}</span>
            </div>
            @endif
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">{{ $task->assignedTo->first_name }} {{ $task->assignedTo->last_name }}</span>
            </div>
            @endif
        </div>
        ...
        <div class="message-box">
            <p><strong>Note from {{ $reminder->creator->first_name }} {{ $reminder->creator->last_name }}:</strong></p>
            <p>{{ $reminder->message }}</p>
        </div>
        @endif

        <div style="text-align: center;">
            <a href="{{ url('/projects/' . $project->id . '/tasks') }}" class="btn">
                View Task Details
            </a>
        </div>

        <div class="footer">
            <p>This reminder was set by <strong>{{ $reminder->creator->first_name }} {{ $reminder->creator->last_name }}</strong></p>
            <p>{{ config('app.name') }} - Team Management System</p>
        </div>
    </div>
</body>
</html>
