    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="checklist-info">
                <h2>{{ $dailyChecklist->template->title }}</h2>
                @if($dailyChecklist->template->description)
                    <p>{{ $dailyChecklist->template->description }}</p>
                @endif
            </div>
                    ...
                    <div class="checklist-item {{ $item->is_completed ? 'completed' : '' }}">
                        ...
                        <div class="item-content">
                            ...
                            @if(!$item->is_completed)
                                <a href="{{ route('checklist.public.toggle', ['token' => $dailyChecklist->email_token, 'item' => $item->id]) }}" 
                                   class="action-button">
                                    Mark as Complete
                                </a>
                            @endif
        ...
        <div class="footer">
            ...
            <p>
                <a href="{{ route('employees.show', $employee) }}">View Full Profile</a>
            </p>
        </div>
    </div>
</body>
