                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); overflow: hidden;">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #000000 0%, #1f2937 100%); padding: 40px; text-align: center;">
                            <img src="{{ asset('black-logo.png') }}" alt="{{ config('app.name') }}" style="height: 48px; margin-bottom: 16px; filter: invert(1);">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: #374151; font-size: 16px; line-height: 1.6; margin: 0 0 32px 0;">
                                You requested to sign in to your {{ config('app.name') }} client portal. Use the code below to complete your login:
                            </p>
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 32px; text-align: center; border-top: 1px solid #e5e7eb;">
                            <p style="color: #6b7280; font-size: 14px; margin: 0 0 8px 0;">
                                Need help? <a href="mailto:{{ config('mail.from.address') }}" style="color: #000000; font-weight: 600; text-decoration: none;">Contact Support</a>
                            </p>
