...
<head>
    ...
    <title>Welcome Back - {{ config('app.name') }}</title>
    ...
    <div class="min-h-full flex">
        ...
        <div class="hidden lg:flex lg:flex-1 relative bg-gradient-to-br from-black via-gray-900 to-gray-800 dark:from-gray-900 dark:via-black dark:to-gray-900">
            ...
            <div class="relative flex flex-col justify-between p-12 text-white">
                <!-- Logo & Brand -->
                <div>
                    <img src="{{ asset('white-logo.png') }}" alt="Ryven Logo" class="h-16 w-auto mb-6">
        ...
        <div class="flex-1 flex items-center justify-center p-8 bg-gray-50 dark:bg-gray-900">
            <div class="w-full max-w-md">
                ...
                <div class="lg:hidden text-center mb-8">
                    <img src="{{ asset('black-logo.png') }}" alt="Ryven Logo" class="h-12 w-auto mx-auto mb-4 dark:invert">
                    <h1 class="text-3xl font-bold text-black dark:text-white mb-2">{{ config('app.name') }}</h1>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-8 shadow-lg" x-data="{
                    ...
                    async sendOtp() {
                        ...
                        try {
                            const response = await fetch('{{ route('client.login.send-otp') }}', {
                                method: 'POST',
                                headers: {
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="email"
                                       ...
                                       required
                                       autofocus
                                       class="w-full px-4 py-3 border dark:border-gray-600 rounded-lg bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent @error('email') !border-red-500 @else border-gray-300 @enderror">
                            </div>
