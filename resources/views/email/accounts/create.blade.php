<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('email.accounts.store') }}" method="POST" class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-3xl p-8">
                @csrf
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select name="imap_encryption" id="imap_encryption"
                                class="w-full px-4 py-3 bg-black border border-gray-800 rounded-2xl text-white focus:outline-none focus:border-white transition">
                ...
                <div class="mb-8 p-6 bg-gray-50 dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700">
                    <label class="flex items-center">
                        <input type="checkbox" name="is_default" value="1" {{ old('is_default') ? 'checked' : '' }}
                            class="w-5 h-5 bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-700 rounded text-black focus:ring-black focus:ring-offset-0">
                        <span class="ml-3 text-gray-900 dark:text-white font-semibold">Set as default account</span>
                    </label>
                </div>
