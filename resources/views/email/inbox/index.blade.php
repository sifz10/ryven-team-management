            ...
            <div class="max-w-screen-2xl mx-auto px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-3" x-data="{ isSyncing: false }">
                        ...
                        <a href="{{ route('email.inbox.compose') }}" class="inline-flex items-center px-6 py-2 bg-black text-white rounded-full font-semibold text-sm hover:bg-gray-800 transition">
                        ...
                        <a href="{{ route('email.accounts.index') }}" class="inline-flex items-center px-6 py-2 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white rounded-full font-semibold text-sm hover:bg-gray-200 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 transition">
                            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-3xl p-4 sticky top-24">
                        <nav class="space-y-1">
                            <a href="{{ route('email.inbox.index', ['account' => $currentAccount?->id, 'folder' => 'INBOX']) }}" 
                                class="flex items-center px-4 py-3 rounded-2xl {{ $folder == 'INBOX' ? 'bg-black text-white' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }} transition">
                            ...
                            <a href="{{ route('email.inbox.index', ['account' => $currentAccount?->id, 'folder' => 'Sent']) }}" 
                                class="flex items-center px-4 py-3 rounded-2xl {{ $folder == 'Sent' ? 'bg-white text-black' : 'text-gray-400 hover:bg-gray-900' }} transition">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('email.inbox.index', ['account' => $currentAccount?->id, 'folder' => 'Drafts']) }}" 
                                class="flex items-center px-4 py-3 rounded-2xl {{ $folder == 'Drafts' ? 'bg-black text-white' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }} transition">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('email.inbox.index', ['account' => $currentAccount?->id, 'folder' => 'Trash']) }}" 
                                class="flex items-center px-4 py-3 rounded-2xl {{ $folder == 'Trash' ? 'bg-black text-white' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }} transition">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('email.inbox.index', ['account' => $currentAccount?->id, 'folder' => $folder, 'filter' => 'unread']) }}" 
                                class="flex items-center px-4 py-3 rounded-2xl {{ $filter == 'unread' ? 'bg-black text-white' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }} transition">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="{{ route('email.inbox.index', ['account' => $currentAccount?->id, 'folder' => $folder, 'filter' => 'starred']) }}" 
                                class="flex items-center px-4 py-3 rounded-2xl {{ $filter == 'starred' ? 'bg-black text-white' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }} transition">
                                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-3xl overflow-hidden">
                            ...
                            @foreach($messages as $message)
                                <div class="group flex items-center p-4 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition {{ !$message->is_read ? 'bg-blue-50 dark:bg-gray-750' : '' }}">
                                    ...
                                    <a href="{{ route('email.inbox.show', $message) }}" class="flex items-center flex-1 min-w-0 ml-4">
                                        <!-- From -->
                                        <div class="w-48 flex-shrink-0">
                                            <p class="font-semibold {{ !$message->is_read ? 'text-gray-900 dark:text-white' : 'text-gray-600 dark:text-gray-400' }} truncate">
