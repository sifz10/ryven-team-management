            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-lg mb-6">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <!-- Facebook -->
                        <a href="{{ route('social.connect.facebook') }}" 
                            class="flex items-center justify-center gap-3 px-6 py-4 bg-black dark:bg-gray-900 border border-transparent rounded-lg font-semibold text-sm text-white hover:bg-gray-800 dark:hover:bg-gray-700 transition">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4" x-data="{ testing: false, testResult: null }">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h4 class="font-semibold text-gray-900 dark:text-gray-100">{{ $account->platform_name }}</h4>
                                                <p class="text-sm text-gray-600 dark:text-gray-400">{{ $account->platform_username ?? 'No username' }}</p>
                                                <div class="flex items-center gap-2 mt-1">
                                                    <span class="text-xs px-2 py-0.5 rounded-full {{ $account->is_active ? 'bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300' }}">
