                ...
                <form method="POST" action="{{ route('employee.profile.update') }}" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full px-4 py-2 bg-gray-900 border border-gray-700 rounded-lg text-gray-500 cursor-not-allowed"
                            disabled
                        >
                        <p class="mt-2 text-xs text-gray-500">Email cannot be changed. Contact admin if needed.</p>
                    </div>
