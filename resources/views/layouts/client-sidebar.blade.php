...
<aside
    ...
    <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700">
        <!-- Logo -->
        <a href="{{ route('client.dashboard') }}" class="flex items-center justify-center overflow-hidden">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1 scrollbar-hide">
        ...
        <a href="{{ route('client.dashboard') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all group {{ request()->routeIs('client.dashboard') ? 'bg-black dark:bg-white text-white dark:text-black' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
        ...
        <a href="{{ route('client.projects.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all group {{ request()->routeIs('client.projects.*') ? 'bg-black dark:bg-white text-white dark:text-black' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('client.team.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all group {{ request()->routeIs('client.team.*') ? 'bg-black dark:bg-white text-white dark:text-black' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('client.invoices.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all group {{ request()->routeIs('client.invoices.*') ? 'bg-black dark:bg-white text-white dark:text-black' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('client.tickets.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all group {{ request()->routeIs('client.tickets.*') ? 'bg-black dark:bg-white text-white dark:text-black' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('client.profile') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all group {{ request()->routeIs('client.profile') ? 'bg-black dark:bg-white text-white dark:text-black' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
