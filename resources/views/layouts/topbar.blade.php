        ...
        <div class="flex items-center gap-2 sm:gap-4">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open"
                    ...
                    <div class="px-4 py-3">
                        @if(Auth::guard('employee')->check())
                            <p class="text-sm font-medium text-gray-900 dark:text-white">{{ Auth::guard('employee')->user()->full_name }}</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 truncate">{{ Auth::guard('employee')->user()->email }}</p>
