    ...
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-2">
                <a href="{{ route('employees.create') }}" class="inline-flex items-center justify-center px-5 py-2.5 bg-black dark:bg-white text-white dark:text-black font-semibold rounded-full hover:bg-gray-800 dark:hover:bg-gray-200 transition shadow-sm">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-2xl border-2 border-blue-200 dark:border-blue-700 p-5 hover:shadow-lg transition-shadow">
                    ...
                    <div class="text-3xl font-bold text-blue-900 dark:text-blue-100 mb-1">{{ $employeesCount }}</div>
                ...
                <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-2xl border-2 border-green-200 dark:border-green-700 p-5 hover:shadow-lg transition-shadow">
                    ...
                    <div class="text-3xl font-bold text-green-900 dark:text-green-100 mb-1">{{ $attendanceStats['attendance_rate'] }}%</div>
                    ...
                    <div class="mt-3 pt-3 border-t border-green-300 dark:border-green-700 text-xs text-green-600 dark:text-green-400">
                        Last 30 days • {{ $attendanceStats['present'] }} present
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-2xl border-2 border-purple-200 dark:border-purple-700 p-5 hover:shadow-lg transition-shadow">
                    ...
                    <div class="text-3xl font-bold text-purple-900 dark:text-purple-100 mb-1">{{ $githubStats['total_commits'] }}</div>
                    ...
                    <div class="mt-3 pt-3 border-t border-purple-300 dark:border-purple-700 text-xs text-purple-600 dark:text-purple-400">
                        {{ $githubStats['pull_requests'] }} PRs • {{ $githubStats['reviews'] }} Reviews
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-2xl border-2 border-orange-200 dark:border-orange-700 p-5 hover:shadow-lg transition-shadow">
                    ...
                    <div class="text-3xl font-bold text-orange-900 dark:text-orange-100 mb-1">{{ $paymentsMonthCount }}</div>
                    ...
                    @if($paymentTrend != 0)
                        <div class="mt-3 pt-3 border-t border-orange-300 dark:border-orange-700 flex items-center text-xs">
                            @if($paymentTrend > 0)
                                ...
                                <span class="text-green-600 dark:text-green-400 font-semibold">+{{ $paymentTrend }}%</span>
                            @else
                                <svg class="w-3 h-3 text-red-600 dark:text-red-400 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path>
                                </svg>
                                <span class="text-red-600 dark:text-red-400 font-semibold">{{ $paymentTrend }}%</span>
                            @endif
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm">
                <div class="p-5 border-b border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('employees.index') }}" class="text-sm font-medium text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition">
                            View all →
                        </a>
                    </div>
                </div>
                        ...
                        @forelse($topPerformers->take(4) as $index => $performer)
                            <a href="{{ route('employees.show', $performer) }}" class="flex items-center gap-3 p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:shadow-lg hover:border-gray-300 dark:hover:border-gray-600 transition-all group">
                                <div class="flex-shrink-0">
                                    ...
                                    @endphp
                                    <div class="w-12 h-12 rounded-full {{ $color }} flex items-center justify-center font-bold text-lg group-hover:scale-110 transition-transform">
                                        #{{ $index + 1 }}
                                    </div>
                                </div>
            ...
            <div class="space-y-4">
                ...
                <div class="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
                    ...
                    <div class="text-3xl font-bold text-gray-900 dark:text-white mb-1">{{ $newHires }}</div>
                    <div class="text-sm text-gray-600 dark:text-gray-400">New hires (30 days)</div>
                    <a href="{{ route('employees.index') }}" class="mt-3 inline-flex items-center text-xs font-medium text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition">
                        View all employees →
                    </a>
                </div>
                ...
                <div class="bg-gradient-to-br from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-5">
                    ...
                    <div class="text-3xl font-bold text-gray-900 dark:text-white mb-1">{{ $contractsCount }}</div>
                    ...
                    <div class="pt-3 border-t border-gray-200 dark:border-gray-700 flex justify-between text-xs">
                        <span class="text-green-600 dark:text-green-400 font-semibold">✓ {{ $activeContractsCount }} Active</span>
                        <span class="text-gray-600 dark:text-gray-400 font-semibold">📝 {{ $draftContractsCount }} Draft</span>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        @forelse($departmentAnalytics as $dept)
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <span class="px-2.5 py-1 bg-black dark:bg-white text-white dark:text-black rounded-full text-xs font-semibold">{{ $dept['employee_count'] }} employees</span>
                                </div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                        @foreach($performanceTrends as $trend)
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-3">
                                <div class="text-xs font-semibold text-gray-600 dark:text-gray-400 mb-2">{{ $trend['month'] }}</div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    @forelse ($monthlyByCurrency as $row)
                        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 hover:shadow-lg transition-shadow">
                            <div class="flex items-center justify-between mb-3">
                                <span class="px-3 py-1.5 bg-black dark:bg-white text-white dark:text-black rounded-lg text-sm font-bold shadow-sm">{{ $row->currency }}</span>
