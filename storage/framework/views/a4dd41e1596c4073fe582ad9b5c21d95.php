        ...
        <div class="flex items-center gap-2 sm:gap-4">
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open"
                    ...
                    <div class="w-8 h-8 rounded-full bg-black dark:bg-white flex items-center justify-center">
                        <span class="text-white dark:text-black font-semibold text-sm">
                            <?php if(Auth::guard('employee')->check()): ?>
                                <?php echo e(strtoupper(substr(Auth::guard('employee')->user()->first_name, 0, 1))); ?>
                    ...
                    <div class="hidden sm:block text-left">
                        <p class="text-sm font-medium">
                            <?php if(Auth::guard('employee')->check()): ?>
                                <?php echo e(Auth::guard('employee')->user()->full_name); ?>
                ...
                <div x-show="open"
                    ...
                    <div class="px-4 py-3">
                        <?php if(Auth::guard('employee')->check()): ?>
                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e(Auth::guard('employee')->user()->full_name); ?></p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 truncate"><?php echo e(Auth::guard('employee')->user()->email); ?></p>
                            <p class="text-xs text-blue-500 mt-1">Employee Account</p>
                        <?php else: ?>
                            ...
                            <p class="text-xs text-purple-500 mt-1">Admin Account</p>
                        <?php endif; ?>
                    </div>
...
<?php /**PATH D:\Ryven Works\ryven-team-management\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>