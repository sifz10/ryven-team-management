                    ...
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-2">
                                <a href="<?php echo e(route('tickets.show', $ticket)); ?>" class="hover:text-black dark:hover:text-white">
...
function ticketManager() {
    return {
        ...
        applyFilters() {
            ...
            window.location.href = '<?php echo e(route("tickets.index")); ?>?' + params.toString();
        },
...
<?php endif; ?>
<?php /**PATH D:\Ryven Works\ryven-team-management\resources\views/tickets/index.blade.php ENDPATH**/ ?>