     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-100 leading-tight">
                <?php echo e(__('Standard Operating Procedure (SOP)')); ?>
                            ...
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="rounded-xl border border-gray-200 dark:border-gray-700 p-4 hover:shadow">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p class="font-medium text-gray-900 dark:text-white"><?php echo e($r['role']); ?></p>
                                            <p class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($r['desc']); ?></p>
                                        </div>
                                    </div>
                                </div>
                         ...
                         <ol class="mt-6 relative border-s-2 border-dashed border-indigo-200 dark:border-indigo-300/40 ps-6 space-y-4">
                            ...
                            ?>
                             ...
                             <?php $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                 <li class="relative stage-item" <?php if(isset($stageAnchors[$stage['title']])): ?> id="<?php echo e($stageAnchors[$stage['title']]); ?>" <?php endif; ?>>
                                    ...
                                    <details open class="ms-6 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-0 shadow-sm overflow-hidden stage-card">
                                        <summary class="flex cursor-pointer items-center justify-between gap-4 px-5 py-4 select-none">
                                            <div>
                                                <h3 class="text-base font-semibold text-gray-900 dark:text-white"><?php echo e($stage['title']); ?></h3>
                                                <span class="mt-1 inline-flex items-center rounded-full bg-indigo-50 dark:bg-indigo-400/20 px-2 py-0.5 text-xs font-medium text-indigo-700 dark:text-indigo-200">Responsible: <?php echo e($stage['resp']); ?></span>
                                            </div>
                                        ...
                                        <div class="px-5 pb-5">
                                            <ul class="mt-1 list-disc ps-5 text-sm text-gray-700 dark:text-gray-300 space-y-1">
                                                <?php $__currentLoopData = $stage['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $it): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li><?php echo e($it); ?></li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </ul>
                                            <div class="mt-4 flex flex-wrap items-center gap-2">
                                                <?php $__currentLoopData = $stage['deliverables']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <span class="inline-flex items-center rounded-full bg-gray-50 dark:bg-gray-700/50 px-2.5 py-1 text-xs font-medium text-gray-700 dark:text-gray-200 ring-1 ring-inset ring-gray-200 dark:ring-gray-600"><?php echo e($d); ?></span>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        </div>
                                    </details>
                            ...
                            <div class="mt-4 overflow-x-auto">
                                <table class="min-w-full text-left text-sm">
                                    ...
                                    <tbody class="text-gray-700 dark:text-gray-300">
                                        ...
                                        ?>
                                        <?php $__currentLoopData = $comm; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="border-t border-gray-100">
                                                <td class="py-2"><?php echo e($c[0]); ?></td>
                                                <td class="py-2"><?php echo e($c[1]); ?></td>
                                                <td class="py-2"><?php echo e($c[2]); ?></td>
                                                <td class="py-2"><?php echo e($c[3]); ?></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                                </table>
                    ...
                    <div class="grid gap-6 md:grid-cols-2">
                        <div class="rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm">
                            ...
                            <ul class="mt-3 space-y-2">
                                <?php $__currentLoopData = $perf; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="flex items-start gap-3">
                                        <span class="mt-1 inline-block h-2.5 w-2.5 rounded-full bg-purple-500"></span>
                                        <p class="text-gray-700 dark:text-gray-300"><span class="font-medium text-gray-900 dark:text-white"><?php echo e($p[0]); ?>:</span> <?php echo e($p[1]); ?></p>
                                    </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        </div>
...
<?php /**PATH F:\Project\salary\resources\views/sop.blade.php ENDPATH**/ ?>