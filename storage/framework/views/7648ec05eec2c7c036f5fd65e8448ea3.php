...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon-button','data' => ['variant' => 'black','href' => ''.e(route('admin.jobs.index')).'','class' => 'flex-shrink-0']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'black','href' => ''.e(route('admin.jobs.index')).'','class' => 'flex-shrink-0']); ?>
...
<?php endif; ?>
                        <div class="flex-1 min-w-0">
                            <h1 class="text-xl sm:text-2xl font-bold text-black dark:text-white truncate"><?php echo e($job->title); ?></h1>
                            <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mt-1">
                                Created <?php echo e($job->created_at->diffForHumans()); ?> by <?php echo e($job->creator->first_name); ?> <?php echo e($job->creator->last_name); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.black-button','data' => ['variant' => 'outline','href' => ''.e(route('admin.jobs.edit', $job)).'','class' => 'flex-1 sm:flex-initial']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','href' => ''.e(route('admin.jobs.edit', $job)).'','class' => 'flex-1 sm:flex-initial']); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginaldf9bc64087ea57ded106e8b72ce8d783 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldf9bc64087ea57ded106e8b72ce8d783 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.black-button','data' => ['onclick' => 'copyPublicUrl()','class' => 'flex-1 sm:flex-initial']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('black-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['onclick' => 'copyPublicUrl()','class' => 'flex-1 sm:flex-initial']); ?>
                            <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-start gap-3 sm:gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs sm:text-sm text-green-700 dark:text-green-300 mt-1">
                                Public URL: <a href="<?php echo e($job->public_url); ?>" target="_blank" class="underline hover:no-underline break-all"><?php echo e($job->public_url); ?></a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-5 hover:shadow-lg hover:scale-105 transition-all duration-300">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-black dark:text-white mt-1"><?php echo e($applicationStats['total']); ?></p>
                        </div>
                ...
                <div class="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-green-200 dark:border-green-800/50 p-4 sm:p-5 hover:shadow-lg hover:shadow-green-100 dark:hover:shadow-green-900/20 hover:scale-105 transition-all duration-300">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-green-600 dark:text-green-400 mt-1"><?php echo e($applicationStats['best_match']); ?></p>
                        </div>
                ...
                <div class="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-blue-200 dark:border-blue-800/50 p-4 sm:p-5 hover:shadow-lg hover:shadow-blue-100 dark:hover:shadow-blue-900/20 hover:scale-105 transition-all duration-300">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-blue-600 dark:text-blue-400 mt-1"><?php echo e($applicationStats['good_to_go']); ?></p>
                        </div>
                ...
                <div class="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-red-200 dark:border-red-800/50 p-4 sm:p-5 hover:shadow-lg hover:shadow-red-100 dark:hover:shadow-red-900/20 hover:scale-105 transition-all duration-300">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-red-600 dark:text-red-400 mt-1"><?php echo e($applicationStats['not_good_fit']); ?></p>
                        </div>
                ...
                <div class="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-yellow-200 dark:border-yellow-800/50 p-4 sm:p-5 hover:shadow-lg hover:shadow-yellow-100 dark:hover:shadow-yellow-900/20 hover:scale-105 transition-all duration-300 col-span-2 md:col-span-3 lg:col-span-1">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-yellow-600 dark:text-yellow-400 mt-1"><?php echo e($applicationStats['pending']); ?></p>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-4 sm:space-y-6">
                    ...
                    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 shadow-sm">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="font-medium text-black dark:text-white mt-1"><?php echo e($job->department ?? 'Not specified'); ?></p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Job Type</p>
                                <p class="font-medium text-black dark:text-white mt-1"><?php echo e(ucfirst(str_replace('-', ' ', $job->job_type))); ?></p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Location</p>
                                <p class="font-medium text-black dark:text-white mt-1"><?php echo e($job->location ?? 'Not specified'); ?></p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Experience Level</p>
                                <p class="font-medium text-black dark:text-white mt-1"><?php echo e($job->experience_level ? ucfirst($job->experience_level) : 'Not specified'); ?></p>
                            </div>
                            <div>
                                ...
                                <p class="font-medium text-black dark:text-white mt-1">
                                    <?php if($job->salary_min || $job->salary_max): ?>
                                        <?php echo e(number_format($job->salary_min, 0)); ?> - <?php echo e(number_format($job->salary_max, 0)); ?> <?php echo e($job->salary_currency); ?>
                            ...
                            <div>
                                ...
                                <p class="font-medium text-black dark:text-white mt-1"><?php echo e($job->positions_available); ?></p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Application Deadline</p>
                                <p class="font-medium text-black dark:text-white mt-1">
                                    <?php echo e($job->application_deadline ? $job->application_deadline->format('M d, Y') : 'No deadline'); ?>

                                </p>
                            </div>
                            <div>
                                <p class="text-sm text-gray-600 dark:text-gray-400">Contact Email</p>
                                <p class="font-medium text-black dark:text-white mt-1"><?php echo e($job->contact_email ?? 'Not specified'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if($job->questions->count() > 0): ?>
                        <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 shadow-sm">
                            <h2 class="text-base sm:text-lg font-semibold text-black dark:text-white mb-4">Screening Questions (<?php echo e($job->questions->count()); ?>)</h2>
                                ...
                                <?php $__currentLoopData = $job->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-3 sm:p-4">
                                        <div class="flex items-start gap-3">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <p class="font-medium text-sm sm:text-base text-black dark:text-white"><?php echo e($question->question); ?></p>
                ...
                <div class="space-y-4 sm:space-y-6">
                    ...
                    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 shadow-sm">
                        ...
                        <div class="space-y-3">
                            <?php if (isset($component)) { $__componentOriginaldf9bc64087ea57ded106e8b72ce8d783 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldf9bc64087ea57ded106e8b72ce8d783 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.black-button','data' => ['href' => ''.e(route('admin.applications.index', ['job_post' => $job->id])).'','class' => 'w-full justify-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('black-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('admin.applications.index', ['job_post' => $job->id])).'','class' => 'w-full justify-center']); ?>
                                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                                </svg>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('admin.jobs.bulk-upload', $job)).'','class' => 'w-full justify-center bg-purple-600 hover:bg-purple-700 dark:bg-purple-600 dark:hover:bg-purple-700']); ?>
                                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginaldf9bc64087ea57ded106e8b72ce8d783 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldf9bc64087ea57ded106e8b72ce8d783 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.black-button','data' => ['variant' => 'outline','onclick' => 'window.open(\''.e($job->public_url).'\', \'_blank\')','class' => 'w-full justify-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('black-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','onclick' => 'window.open(\''.e($job->public_url).'\', \'_blank\')','class' => 'w-full justify-center']); ?>
                                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php endif; ?>
                    ...
                    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 shadow-sm">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="inline-flex px-2.5 py-1 text-xs font-semibold rounded-md <?php echo e($job->ai_screening_enabled ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-400'); ?>">
                                    <?php echo e($job->ai_screening_enabled ? 'Enabled' : 'Disabled'); ?>

                                </span>
                            </div>
                            <?php if($job->ai_screening_criteria): ?>
                                <div>
                                    <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-2">Criteria</p>
                                    <p class="text-xs sm:text-sm text-gray-700 dark:text-gray-300"><?php echo e($job->ai_screening_criteria); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 shadow-sm">
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <p class="text-xs sm:text-sm font-mono text-gray-700 dark:text-gray-300 mt-1 break-all"><?php echo e($job->slug); ?></p>
                            </div>
                            <div>
                                <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Created</p>
                                <p class="text-xs sm:text-sm text-gray-700 dark:text-gray-300 mt-1"><?php echo e($job->created_at->format('M d, Y g:i A')); ?></p>
                            </div>
                            <div>
                                <p class="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Last Updated</p>
                                <p class="text-xs sm:text-sm text-gray-700 dark:text-gray-300 mt-1"><?php echo e($job->updated_at->format('M d, Y g:i A')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <input type="hidden" id="public-url" value="<?php echo e($job->public_url); ?>">
...
<?php endif; ?>
<?php /**PATH F:\Project\salary\resources\views/admin/jobs/show.blade.php ENDPATH**/ ?>