     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap items-center gap-2 sm:gap-3">
                ...
                <a href="<?php echo e(route('employees.create')); ?>" class="inline-flex items-center gap-2 px-4 sm:px-5 py-2 sm:py-2.5 bg-black text-white dark:bg-white dark:text-black rounded-full hover:bg-gray-800 dark:hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-black dark:focus:ring-white focus:ring-offset-2 transition-all duration-200 font-semibold text-sm sm:text-base">
                    <svg class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 group">
                        ...
                        <div class="px-4 pb-4 flex items-center gap-2">
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('edit-employees')): ?>
                            ...
                            <?php endif; ?>
                            <?php if(auth()->user()->hasPermission('delete-employees')): ?>
                            <form method="POST" action="<?php echo e(route('employees.destroy', $employee)); ?>" id="delete-form-<?php echo e($employee->id); ?>" class="inline">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="button"
                                        @click="$dispatch('open-delete-modal', { id: 'deleteModal', form: document.getElementById('delete-form-<?php echo e($employee->id); ?>') })"
                                        class="inline-flex items-center justify-center p-2 bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-300 rounded-full hover:bg-red-200 dark:hover:bg-red-900/40 transition-all"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-modal','data' => ['id' => 'deleteModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['id' => 'deleteModal']); ?>
         <?php $__env->slot('title', null, []); ?> Delete Employee <?php $__env->endSlot(); ?>
         <?php $__env->slot('message', null, []); ?> 
            Are you sure you want to delete this employee? This action can be undone from the Deleted Users tab.
         <?php $__env->endSlot(); ?>
...
<?php endif; ?>
<?php /**PATH D:\Ryven Works\ryven-team-management\resources\views/employees/index.blade.php ENDPATH**/ ?>