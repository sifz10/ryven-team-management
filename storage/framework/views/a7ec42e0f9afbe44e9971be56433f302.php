<div x-data="{
    ...
    <div class="flex items-center justify-between">
        <h3 class="text-lg font-bold text-gray-900 dark:text-white">
            Discussion (<?php echo e($project->discussions->count()); ?> messages)
        </h3>
    ...
    <div x-show="showMessageForm" x-transition class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        <form action="<?php echo e(route('projects.discussions.store', $project)); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
    ...
    <?php if($pinnedMessages->count() > 0): ?>
        <div class="space-y-3">
            ...
            <?php $__currentLoopData = $pinnedMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo $__env->make('projects.tabs.partials.discussion-message', ['message' => $message, 'isPinned' => true], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    <?php endif; ?>

    <!-- All Messages -->
    <?php if($project->discussions->where('parent_id', null)->count() > 0): ?>
        <div class="space-y-4">
            <?php $__currentLoopData = $project->discussions->where('parent_id', null)->sortByDesc('created_at'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(!$message->is_pinned): ?>
                    <?php echo $__env->make('projects.tabs.partials.discussion-message', ['message' => $message, 'isPinned' => false], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    <?php else: ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const teamMembers = [
        ...
        {
            key: '<?php echo e($member->employee->first_name); ?> <?php echo e($member->employee->last_name); ?>',
            value: '<?php echo e($member->employee->first_name); ?> <?php echo e($member->employee->last_name); ?>',
            email: '<?php echo e($member->employee->email ?? ''); ?>',
            initials: '<?php echo e(substr($member->employee->first_name, 0, 1)); ?><?php echo e(substr($member->employee->last_name, 0, 1)); ?>'
        },
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ];
...
<?php /**PATH F:\Project\salary\resources\views/projects/tabs/discussion.blade.php ENDPATH**/ ?>