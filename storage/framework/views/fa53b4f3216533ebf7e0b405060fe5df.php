            ...
            <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-2xl font-bold text-gray-900 dark:text-white mt-1"><?php echo e($totalActivities); ?></div>
                    </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 rounded-xl p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-2xl font-bold text-blue-900 dark:text-blue-200 mt-1"><?php echo e($totalCommits); ?></div>
                    </div>
            ...
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 rounded-xl p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-2xl font-bold text-purple-900 dark:text-purple-200 mt-1"><?php echo e($prCount); ?></div>
                    </div>
            ...
            <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/30 rounded-xl p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-2xl font-bold text-green-900 dark:text-green-200 mt-1"><?php echo e($repositories->count()); ?></div>
                    </div>
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-4">
                                <div class="flex-1">
                                    ...
                                    <!-- Repository Name -->
                                    <a href="<?php echo e($log->repository_url); ?>" target="_blank" class="inline-flex items-center text-sm font-semibold text-gray-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 transition">
                                            ...
                                            <?php if($log->commit_message): ?>
                                                <div class="mt-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
                                                    <p class="text-sm text-gray-700 dark:text-gray-300 font-mono">
                                                        <?php echo e(Str::limit($log->commit_message, 150)); ?>
                                    ...
                                    <?php elseif(in_array($log->event_type, ['pull_request_review', 'pull_request_review_comment'])): ?>
                                        <div class="mt-2">
                                            ...
                                            <?php if($log->commit_message): ?>
                                                <div class="mt-2 p-3 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
                                                    <p class="text-sm text-gray-700 dark:text-gray-300">
                                                        <?php echo e(Str::limit($log->commit_message, 200)); ?>
