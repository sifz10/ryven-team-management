    ...
    <div class="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-4">
            ...
            <div class="flex items-center gap-2">
                <span class="hidden sm:inline-flex items-center px-3 py-1 bg-black/5 dark:bg-white/5 text-black dark:text-white text-sm font-medium rounded-full">
                    Client Portal
                </span>
            </div>
        </div>
                ...
                <button @click="open = !open"
                    ...
                    <div class="w-8 h-8 rounded-full bg-black dark:bg-white flex items-center justify-center">
                        <span class="text-white dark:text-black font-semibold text-sm">
                            <?php echo e(strtoupper(substr(Auth::guard('client')->user()->name, 0, 1))); ?>
                ...
                <div x-show="open"
                    ...
                    <div class="py-1">
                        <form method="POST" action="<?php echo e(route('client.logout')); ?>">
                            <?php echo csrf_field(); ?>
                            <button type="submit"
                                    class="w-full flex items-center gap-3 px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH F:\Project\salary\resources\views/layouts/client-topbar.blade.php ENDPATH**/ ?>