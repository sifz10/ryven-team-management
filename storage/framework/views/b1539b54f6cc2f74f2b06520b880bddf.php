     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <a href="<?php echo e(route('employees.index')); ?>" class="inline-flex items-center px-4 py-2 bg-white text-gray-800 rounded-full border border-gray-300 shadow-sm hover:bg-gray-100">Back</a>
                <a href="<?php echo e(route('employees.edit', $employee)); ?>" class="inline-flex items-center px-4 py-2 bg-black text-white rounded-full shadow hover:bg-gray-800">Edit</a>
                <?php if(!$employee->discontinued_at): ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'bg-black hover:bg-gray-800']); ?>Apply <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    <?php if(request('from') || request('to')): ?>
                                        <a href="<?php echo e(route('employees.show', $employee)); ?>" class="text-gray-700 text-sm">Clear</a>
                                    <?php endif; ?>
                                </div>
                            </form>
                            <?php if(request('from') || request('to')): ?>
                                <div class="mt-2 text-xs text-gray-500 dark:text-gray-400">Filtering payments <?php if(request('from')): ?> from <?php echo e(request('from')); ?> <?php endif; ?> <?php if(request('to')): ?> to <?php echo e(request('to')); ?> <?php endif; ?></div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <div class="mt-1 text-2xl font-semibold"><?php echo e(number_format($totalPaid, 2)); ?> <?php echo e($currencyCode); ?></div>
                            </div>
                            <div>
                                <div class="text-sm text-gray-600">Monthly Salary</div>
                                <div class="mt-1 text-2xl font-semibold"><?php echo e(number_format($monthlySalary, 2)); ?> <?php echo e($currencyCode); ?></div>
                            </div>
                            <div>
                                <div class="text-sm text-gray-600">Annual (12 mo)</div>
                                <div class="mt-1 text-2xl font-semibold"><?php echo e(number_format($monthlySalary * 12, 2)); ?> <?php echo e($currencyCode); ?></div>
                            </div>
                        </div>
                        <div class="px-6 pb-6">
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                <?php $__currentLoopData = $forecastMonths; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="rounded-xl border border-gray-200 p-4">
                                        <div class="text-xs uppercase tracking-wide text-gray-600"><?php echo e($m); ?> months</div>
                                        <div class="mt-1 text-lg font-semibold"><?php echo e(number_format($monthlySalary * $m, 2)); ?> <?php echo e($currencyCode); ?></div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
                            <div class="mt-6 flex items-center gap-4">
                                <a href="<?php echo e(route('employees.edit', $employee)); ?>" class="text-indigo-600">Edit</a>
                                <a href="<?php echo e(route('employees.index')); ?>" class="text-gray-600">Back</a>
                                <?php if($employee->discontinued_at): ?>
                                    <span class="text-xs text-red-600">Discontinued at <?php echo e($employee->discontinued_at->toDayDateTimeString()); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <?php $__empty_1 = true; $__currentLoopData = $orgPaidByCurrency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="rounded-xl border border-gray-200 dark:border-gray-700 p-4 flex items-center justify-between">
                                    <div class="text-sm text-gray-600 dark:text-gray-300"><?php echo e($row->currency); ?></div>
                                    <div class="text-xl font-semibold"><?php echo e(number_format($row->total, 2)); ?> <?php echo e($row->currency); ?></div>
                                </div>
            ...
            <div x-cloak x-show="tab==='timeline'" x-transition.opacity class="mt-6 bg-white dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm dark:shadow-lg sm:rounded-2xl">
                <div class="p-6 text-gray-900 dark:text-white">
                    <?php if(session('status')): ?>
                        <div class="mb-4 px-4 py-3 bg-green-50 dark:bg-green-500/20 border border-green-200 dark:border-green-500/30 rounded-lg text-green-700 dark:text-green-300"><?php echo e(session('status')); ?></div>
                    <?php endif; ?>
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex items-center gap-2">
                            <span class="px-3 py-1 bg-gray-100 dark:bg-gray-700/50 rounded-full text-xs text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-transparent"><?php echo e($payments->count()); ?> entries</span>
                        </div>
                    </div>
...
<?php /**PATH F:\Project\salary\resources\views/employees/show.blade.php ENDPATH**/ ?>