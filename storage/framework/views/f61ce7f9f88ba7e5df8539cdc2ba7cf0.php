                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <?php $__empty_1 = true; $__currentLoopData = $topPerformers->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $performer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <a href="<?php echo e(route('employees.show', $performer->employee)); ?>" class="flex items-center gap-3 p-4 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:shadow-lg hover:border-gray-300 dark:hover:border-gray-600 transition-all group">
                                ...
                                <div class="flex-1 min-w-0">
                                    <?php if($performer->employee): ?>
                                        <div class="font-bold text-gray-900 dark:text-white truncate group-hover:text-black dark:group-hover:text-gray-200">
                                            <?php echo e($performer->employee->first_name); ?> <?php echo e($performer->employee->last_name); ?>

                                        </div>
                                        <div class="text-xs text-gray-500 dark:text-gray-400 truncate"><?php echo e($performer->employee->position ?? 'No position'); ?></div>
                                    <?php endif; ?>
                                </div>
