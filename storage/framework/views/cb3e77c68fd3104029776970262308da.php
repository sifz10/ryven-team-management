     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                <?php echo e(__('Create Social Media Post')); ?>
                ...
                <div class="bg-yellow-100 dark:bg-yellow-900 border border-yellow-400 dark:border-yellow-700 text-yellow-700 dark:text-yellow-300 px-4 py-3 rounded-lg mb-6">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="mt-1">Please <a href="<?php echo e(route('social.accounts.index')); ?>" class="underline font-semibold">connect your accounts</a> before creating posts.</p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>

            <form action="<?php echo e(route('social.posts.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="social_account_id" id="social_account_id" x-model="socialAccountId"
                                ...
                                <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($account->id); ?>"><?php echo e($account->platform_name); ?> - <?php echo e($account->platform_username); ?></option>
...
<?php endif; ?>
<?php /**PATH F:\Project\salary\resources\views/social/posts/create.blade.php ENDPATH**/ ?>