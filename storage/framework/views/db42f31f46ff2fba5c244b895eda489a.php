        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm sm:rounded-2xl mb-6">
                <div class="p-6">
                    ...
                    <form method="GET" action="<?php echo e(route('attendance.index')); ?>" class="flex flex-wrap gap-4 items-end">
            ...
            <?php if($selectedEmployee): ?>
                ...
                <div class="bg-gradient-to-r from-gray-800 to-black rounded-2xl shadow-lg p-6 mb-6 text-white border border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-2xl font-bold"><?php echo e($selectedEmployee->first_name); ?> <?php echo e($selectedEmployee->last_name); ?></h3>
                            <p class="text-gray-300 mt-1"><?php echo e($selectedEmployee->position); ?></p>
                            <p class="text-gray-300 text-sm mt-2">Base Salary: <?php echo e(number_format($selectedEmployee->salary, 2)); ?> <?php echo e($selectedEmployee->currency ?? 'USD'); ?></p>
                            <p class="text-gray-400 text-xs mt-1">Hourly Rate: <?php echo e(number_format($selectedEmployee->salary / 208, 2)); ?> <?php echo e($selectedEmployee->currency ?? 'USD'); ?>/hr</p>
                        </div>
                        <div class="text-right">
                            <p class="text-gray-400 text-sm">Viewing</p>
                            <p class="text-2xl font-bold"><?php echo e(\Carbon\Carbon::create($year, $month)->format('F Y')); ?></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-7 gap-2 mb-4">
                            <?php $__currentLoopData = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="text-center font-semibold text-gray-700 dark:text-gray-300 py-2"><?php echo e($day); ?></div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
...
<?php /**PATH F:\Project\salary\resources\views/attendance/index.blade.php ENDPATH**/ ?>