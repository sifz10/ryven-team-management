...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('notes.create')); ?>" class="inline-flex items-center px-5 py-2.5 bg-black text-white rounded-full shadow-lg hover:bg-gray-800 hover:shadow-xl transition">
    ...
    <div class="space-y-6">
            ...
            <div class="mb-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm p-6">
                <form method="GET" action="<?php echo e(route('notes.index')); ?>" class="flex flex-wrap gap-4">
                    ...
                    <div class="min-w-[180px]">
                        <select name="type" 
                            ...
                            <option value="website_link" <?php echo e(request('type') == 'website_link' ? 'selected' : ''); ?>>🔗 Website Link</option>
                            <option value="password" <?php echo e(request('type') == 'password' ? 'selected' : ''); ?>>🔐 Password</option>
                            <option value="backup_code" <?php echo e(request('type') == 'backup_code' ? 'selected' : ''); ?>>🔑 Backup Code</option>
                            <option value="text" <?php echo e(request('type') == 'text' ? 'selected' : ''); ?>>📝 Text Note</option>
                            <option value="file" <?php echo e(request('type') == 'file' ? 'selected' : ''); ?>>📎 File</option>
                        </select>
                    </div>
                    <button type="submit" 
                ...
                <div class="p-6">
                                ...
                                <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-600 hover:shadow-lg transition">
                                    ...
                                    <div class="flex items-center justify-between mb-4">
                                        <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium
                                            <?php if($note->type == 'website_link'): ?> bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200
                                            <?php elseif($note->type == 'password'): ?> bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-200
                                            <?php elseif($note->type == 'backup_code'): ?> bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200
                                            <?php elseif($note->type == 'text'): ?> bg-green-100 dark:bg-green-900 text-green-800 dark:text-green-200
                                            <?php else: ?> bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200
                                            <?php endif; ?>">
                                            <?php if($note->type == 'website_link'): ?> 🔗 Link
                                            <?php elseif($note->type == 'password'): ?> 🔐 Password
                                            <?php elseif($note->type == 'backup_code'): ?> 🔑 Backup Code
                                            <?php elseif($note->type == 'text'): ?> 📝 Text
                                            <?php else: ?> 📎 File
                                            <?php endif; ?>
                                        </span>
                                        
                                        <?php if($note->reminder_time && !$note->reminder_sent): ?>
                                    ...
                                    <!-- URL Preview -->
                                    <?php if($note->url): ?>
                                        <a href="<?php echo e($note->url); ?>" target="_blank" 
                                    ...
                                    <?php if($note->reminder_time): ?>
                                        <div class="mb-4 text-xs text-gray-500 dark:text-gray-400">
                                            <span class="font-medium">Reminder:</span> <?php echo e($note->reminder_time->format('M d, Y h:i A')); ?>

                                            <?php if($note->recipients->count() > 0): ?>
                                                <br>
                                                <span class="font-medium">To:</span> <?php echo e($note->recipients->pluck('email')->join(', ')); ?>
                    ...
                    <?php else: ?>
                        <div class="text-center py-12">
                            ...
                            <div class="mt-6">
                                <a href="<?php echo e(route('notes.create')); ?>" class="inline-flex items-center px-4 py-2 bg-black text-white rounded-full shadow hover:bg-gray-800 transition">
                                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                    </svg>
                                    New Note
...
<?php endif; ?>
<?php /**PATH D:\Ryven Works\ryven-team-management\resources\views/notes/index.blade.php ENDPATH**/ ?>