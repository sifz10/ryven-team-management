...
<aside
    ...
    <div class="flex items-center justify-between h-16 px-4 border-b border-gray-200 dark:border-gray-700">
        <!-- Logo -->
        <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center justify-center overflow-hidden">
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1 scrollbar-hide">
        <?php if(Auth::guard('employee')->check()): ?>
            ...
            <a href="<?php echo e(route('employee.dashboard')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                      <?php echo e(request()->routeIs('employee.dashboard')
            ...
            <!-- Employee Profile -->
            <a href="<?php echo e(route('employee.profile.edit')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                      <?php echo e(request()->routeIs('employee.profile.*')
                         ? 'bg-black text-white dark:bg-white dark:text-black'
                         : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
               x-tooltip="sidebarCollapsed ? 'My Profile' : ''">
                ...
                <span x-show="!sidebarCollapsed" class="font-medium">My Profile</span>
            </a>
        <?php else: ?>
            <!-- Admin Dashboard -->
        ...
        <?php if(Auth::guard('web')->check()): ?>
            ...
            <a href="<?php echo e(route('employees.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                      <?php echo e(request()->routeIs('employees.*')
                         ? 'bg-black text-white dark:bg-white dark:text-black'
                         : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
            ...
            <a href="<?php echo e(route('attendance.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                      <?php echo e(request()->routeIs('attendance.*')
                         ? 'bg-black text-white dark:bg-white dark:text-black'
                         : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
            ...
            <a href="<?php echo e(route('projects.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                      <?php echo e(request()->routeIs('projects.*')
                         ? 'bg-black text-white dark:bg-white dark:text-black'
                         : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
            ...
            <a href="<?php echo e(route('tickets.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                      <?php echo e(request()->routeIs('tickets.*')
                         ? 'bg-black text-white dark:bg-white dark:text-black'
                         : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
               x-tooltip="sidebarCollapsed ? 'Tickets' : ''">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z"/>
                </svg>
                <span x-show="!sidebarCollapsed" class="font-medium">Tickets</span>
            </a>

            <!-- Admin Only: Clients -->
            <a href="<?php echo e(route('clients.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                      <?php echo e(request()->routeIs('clients.*')
                         ? 'bg-black text-white dark:bg-white dark:text-black'
                         : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
            ...
            <!-- Admin Only: Job Postings -->
            <a href="<?php echo e(route('admin.jobs.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                      <?php echo e(request()->routeIs('admin.jobs.*')
                         ? 'bg-black text-white dark:bg-white dark:text-black'
                         : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
               x-tooltip="sidebarCollapsed ? 'Job Postings' : ''">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                </svg>
                <span x-show="!sidebarCollapsed" class="font-medium">Job Postings</span>
            </a>

            <!-- Admin Only: Applications -->
            <a href="<?php echo e(route('admin.applications.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                      <?php echo e(request()->routeIs('admin.applications.*')
                         ? 'bg-black text-white dark:bg-white dark:text-black'
                         : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
               x-tooltip="sidebarCollapsed ? 'Applications' : ''">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                </svg>
                <span x-show="!sidebarCollapsed" class="font-medium">Applications</span>
            </a>

            <!-- Admin Only: Talent Pool -->
            <a href="<?php echo e(route('admin.talent-pool.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                      <?php echo e(request()->routeIs('admin.talent-pool.*')
                         ? 'bg-black text-white dark:bg-white dark:text-black'
                         : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
               x-tooltip="sidebarCollapsed ? 'Talent Pool' : ''">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                </svg>
        ...
        <a href="<?php echo e(route('uat.index')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                  <?php echo e(request()->routeIs('uat.*')
                     ? 'bg-black text-white dark:bg-white dark:text-black'
                     : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
        ...
        <?php if(Auth::guard('web')->check()): ?>
            <a href="<?php echo e(route('admin.chatbot.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                      <?php echo e(request()->routeIs('admin.chatbot.*')
                         ? 'bg-black text-white dark:bg-white dark:text-black'
                         : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
            ...
            <!-- Chatbot Widgets -->
            <a href="<?php echo e(route('admin.chatbot.widgets.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                      <?php echo e(request()->routeIs('admin.chatbot.widgets.*')
                         ? 'bg-black text-white dark:bg-white dark:text-black'
                         : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
        ...
        <!-- GitHub Logs -->
        <a href="<?php echo e(route('github.logs')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                  <?php echo e(request()->routeIs('github.logs')
                     ? 'bg-black text-white dark:bg-white dark:text-black'
                     : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
        ...
        <a href="<?php echo e(route('ai-agent.index')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                  <?php echo e(request()->routeIs('ai-agent.*')
                     ? 'bg-black text-white dark:bg-white dark:text-black'
                     : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
        ...
        <a href="<?php echo e(route('roles.index')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                  <?php echo e(request()->routeIs('roles.*')
                     ? 'bg-black text-white dark:bg-white dark:text-black'
                     : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
           x-tooltip="sidebarCollapsed ? 'Roles' : ''">
            <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="<?php echo e(route('invoices.index')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                  <?php echo e(request()->routeIs('invoices.*')
                     ? 'bg-black text-white dark:bg-white dark:text-black'
                     : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
        ...
        <a href="<?php echo e(route('contracts.index')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                  <?php echo e(request()->routeIs('contracts.*')
                     ? 'bg-black text-white dark:bg-white dark:text-black'
                     : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
        ...
        <a href="<?php echo e(route('notes.index')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                  <?php echo e(request()->routeIs('notes.*')
                     ? 'bg-black text-white dark:bg-white dark:text-black'
                     : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
        ...
        <a href="<?php echo e(route('email.inbox.index')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group relative
                  <?php echo e(request()->routeIs('email.*')
                     ? 'bg-black text-white dark:bg-white dark:text-black'
                     : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
        ...
        <a href="<?php echo e(route('social.calendar')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                  <?php echo e(request()->routeIs('social.*')
                     ? 'bg-black text-white dark:bg-white dark:text-black'
                     : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
        ...
        <a href="<?php echo e(route('sop')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                  <?php echo e(request()->routeIs('sop')
                     ? 'bg-black text-white dark:bg-white dark:text-black'
                     : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
        ...
        <!-- Review Cycles -->
        <a href="<?php echo e(route('review-cycles.index')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                  <?php echo e(request()->routeIs('review-cycles.*')
                     ? 'bg-black text-white dark:bg-white dark:text-black'
                     : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
        ...
        <!-- Goals & OKRs -->
        <a href="<?php echo e(route('goals.index')); ?>"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                  <?php echo e(request()->routeIs('goals.*')
                     ? 'bg-black text-white dark:bg-white dark:text-black'
                     : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
           x-tooltip="sidebarCollapsed ? 'Goals & OKRs' : ''">
            ...
            <a href="<?php echo e(route('skills.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all duration-200 group
                      <?php echo e(request()->routeIs('skills.*')
                         ? 'bg-black text-white dark:bg-white dark:text-black'
                         : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700'); ?>"
...
<?php /**PATH D:\Ryven Works\ryven-team-management\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>