     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                <?php if(auth()->user()->hasPermission('create-projects')): ?>
                <a href="<?php echo e(route('projects.create')); ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-black text-white dark:bg-white dark:text-black rounded-full hover:bg-gray-800 dark:hover:bg-gray-200 transition-all duration-200 font-semibold text-sm">
            ...
            <div class="bg-gradient-to-br from-gray-800 to-black dark:from-gray-900 dark:to-black rounded-2xl p-6 border border-gray-700 dark:border-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-white mt-2"><?php echo e($projects->where('status', 'on-hold')->count()); ?></p>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all duration-200">
                    ...
                    <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex-1">
                                <h3 class="font-bold text-lg text-gray-900 dark:text-white"><?php echo e($project->name); ?></h3>
                                <?php if($project->client): ?>
                                    <div class="flex items-center gap-2 mt-2">
                                        <?php if($project->client->logo): ?>
                                            <img src="<?php echo e(Storage::url($project->client->logo)); ?>" alt="<?php echo e($project->client->name); ?>" class="w-5 h-5 rounded object-cover">
                                        <?php endif; ?>
                                        <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($project->client->name); ?></p>
                                    </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <?php if($project->description): ?>
                            <p class="text-sm text-gray-600 dark:text-gray-400 line-clamp-2"><?php echo e($project->description); ?></p>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="px-6 py-4 bg-gray-50 dark:bg-gray-900/50 grid grid-cols-3 gap-4">
                        <div class="text-center">
                            <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($project->tasks_count); ?></p>
                        ...
                        <div class="text-center border-x border-gray-200 dark:border-gray-700">
                            <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($project->members_count); ?></p>
                            <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Team</p>
                        </div>
                        <div class="text-center">
                            <p class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($project->progress ?? 0); ?>%</p>
                    ...
                    <?php if($project->progress !== null): ?>
                        <div class="px-6 py-3 bg-gray-50 dark:bg-gray-900/50">
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
                                <div class="bg-gradient-to-r from-gray-800 to-black dark:from-gray-600 dark:to-gray-400 h-2 rounded-full transition-all duration-300" style="width: <?php echo e($project->progress); ?>%"></div>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="p-6 space-y-3">
                        <?php if($project->start_date || $project->end_date): ?>
                            <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <?php if($project->start_date && $project->end_date): ?>
                                    <?php echo e($project->start_date->format('M d')); ?> - <?php echo e($project->end_date->format('M d, Y')); ?>

                                <?php elseif($project->start_date): ?>
                                    Started <?php echo e($project->start_date->format('M d, Y')); ?>

                                <?php elseif($project->end_date): ?>
                                    Due <?php echo e($project->end_date->format('M d, Y')); ?>
                        ...
                        <?php if($project->budget): ?>
                            <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                Budget: <?php echo e(number_format($project->budget, 2)); ?> <?php echo e($project->currency); ?>
                        ...
                        <?php if($project->project_manager): ?>
                            <div class="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                                ...
                                PM: <?php echo e($project->project_manager); ?>
                    ...
                    <div class="p-6 pt-0 flex items-center gap-2">
                        <?php if(auth()->user()->hasPermission('view-projects')): ?>
                            <a href="<?php echo e(route('projects.show', $project)); ?>" class="flex-1 inline-flex items-center justify-center gap-2 px-5 py-2.5 bg-black text-white dark:bg-white dark:text-black rounded-full hover:opacity-90 transition-all font-semibold text-sm shadow-md">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <?php if(auth()->user()->hasPermission('edit-projects')): ?>
                            <a href="<?php echo e(route('projects.edit', $project)); ?>" class="p-2.5 text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                </svg>
                            </a>
                        <?php endif; ?>
                        <?php if(auth()->user()->hasPermission('delete-projects')): ?>
                            <button
                                @click="projectToDelete = <?php echo e($project->id); ?>; projectName = '<?php echo e(addslashes($project->name)); ?>'; showDeleteModal = true"
                                type="button"
...
<?php endif; ?>
<?php /**PATH D:\Ryven Works\ryven-team-management\resources\views/projects/index-new.blade.php ENDPATH**/ ?>