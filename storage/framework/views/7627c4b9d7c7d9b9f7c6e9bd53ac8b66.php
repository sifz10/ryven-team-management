...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap gap-3">
                <a href="<?php echo e(route('social.accounts.index')); ?>" 
                    ...
                    <span class="hidden sm:inline"><?php echo e(__('Accounts')); ?></span>
                    <span class="sm:hidden">Acc</span>
                </a>
                <a href="<?php echo e(route('social.posts.create')); ?>" 
                    class="inline-flex items-center gap-2 px-4 py-2 bg-black dark:bg-white text-white dark:text-black border border-transparent rounded-full font-semibold text-xs uppercase tracking-widest hover:bg-gray-800 dark:hover:bg-gray-100 transition">
                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <script>
        function contentCalendar() {
            return {
                currentDate: new Date('<?php echo e($date->format("Y-m-d")); ?>'),
                calendarData: <?php echo json_encode($calendar, 15, 512) ?>,
...
<?php endif; ?>
<?php /**PATH F:\Project\salary\resources\views/social/calendar/index.blade.php ENDPATH**/ ?>