    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm rounded-2xl">
                <div class="p-8">
                    ...
                    <div class="flex justify-between items-start mb-8">
                        <div>
                            <img src="<?php echo e(asset('black-logo.png')); ?>" alt="Ryven Global LLC" class="h-16 mb-4">
                        ...
                        <div class="text-right">
                            ...
                            <div class="text-sm space-y-1">
                                <p class="text-gray-600 dark:text-gray-400">
                                    ...
                                    <span class="text-gray-900 dark:text-gray-100"><?php echo e($invoice->invoice_number); ?></span>
                                </p>
                                <p class="text-gray-600 dark:text-gray-400">
                                    <span class="font-semibold">Date:</span> 
                                    <span class="text-gray-900 dark:text-gray-100"><?php echo e($invoice->invoice_date->format('M d, Y')); ?></span>
                                </p>
                                <p class="text-gray-600 dark:text-gray-400">
                                    <span class="font-semibold">Due Date:</span> 
                                    <span class="text-gray-900 dark:text-gray-100"><?php echo e($invoice->due_date->format('M d, Y')); ?></span>
                                </p>
                                <div class="mt-2">
                    ...
                    <div class="mb-8 p-6 bg-gray-50 dark:bg-gray-900 rounded-lg">
                        ...
                        <p class="text-lg font-bold text-gray-900 dark:text-gray-100"><?php echo e($invoice->client_name); ?></p>
                        <?php if($invoice->client_email): ?>
                            <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($invoice->client_email); ?></p>
                        <?php endif; ?>
                        <?php if($invoice->client_phone): ?>
                            <p class="text-sm text-gray-600 dark:text-gray-400"><?php echo e($invoice->client_phone); ?></p>
                        <?php endif; ?>
                        <?php if($invoice->client_address): ?>
                            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1 whitespace-pre-line"><?php echo e($invoice->client_address); ?></p>
                        <?php endif; ?>
                    </div>
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-sm text-gray-900 dark:text-gray-100 text-right">
                                            <?php echo e($invoice->currency); ?> <?php echo e(number_format($item['rate'], 2)); ?>
                        ...
                        <div class="w-full md:w-1/2 lg:w-1/3 space-y-3">
                            <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <span class="text-base font-semibold text-gray-900 dark:text-gray-100">
                                    <?php echo e($invoice->currency); ?> <?php echo e(number_format($invoice->subtotal, 2)); ?>
                            ...
                            <?php if($invoice->tax_percentage > 0): ?>
                                <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">
                                        Tax (<?php echo e(number_format($invoice->tax_percentage, 2)); ?>%):
                                    </span>
                                    <span class="text-base font-semibold text-gray-900 dark:text-gray-100">
                                        <?php echo e($invoice->currency); ?> <?php echo e(number_format($invoice->tax_amount, 2)); ?>
                            ...
                            <?php if($invoice->discount_percentage > 0): ?>
                                <div class="flex justify-between items-center py-2 border-b border-gray-200 dark:border-gray-700">
                                    <span class="text-sm text-gray-600 dark:text-gray-400">
                                        Discount (<?php echo e(number_format($invoice->discount_percentage, 2)); ?>%):
                                    </span>
                                    <span class="text-base font-semibold text-red-600 dark:text-red-400">
                                        -<?php echo e($invoice->currency); ?> <?php echo e(number_format($invoice->discount_amount, 2)); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <?php if($invoice->notes): ?>
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 whitespace-pre-line"><?php echo e($invoice->notes); ?></p>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php if($invoice->terms): ?>
                            <div>
                                ...
                                <p class="text-sm text-gray-600 dark:text-gray-400 whitespace-pre-line"><?php echo e($invoice->terms); ?></p>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="mt-12 pt-6 border-t border-gray-200 dark:border-gray-700 text-center">
                        ...
                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-2">
                            Invoice Date: <?php echo e($invoice->invoice_date->format('M d, Y')); ?>
            ...
            <div class="mt-6 flex justify-center gap-4">
                ...
                <form action="<?php echo e(route('invoices.destroy', $invoice)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this invoice? This action cannot be undone.');">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH F:\Project\salary\resources\views/invoices/show.blade.php ENDPATH**/ ?>