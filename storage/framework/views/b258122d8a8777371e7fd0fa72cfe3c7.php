                                ...
                                <?php if($message->attachments && $message->attachments->count() > 0): ?>
                                    <div class="flex flex-wrap gap-2 mb-2">
                                        <?php $__currentLoopData = $message->attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attachment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <?php if($isImage): ?>
                                                <div class="rounded-lg overflow-hidden max-w-xs attachment-btn group cursor-pointer" onclick="openAttachmentPreview('<?php echo e(asset('storage/' . $attachment->file_path)); ?>', '<?php echo e($attachment->file_name); ?>', 'image')" title="Click to preview">
                                                    <img src="<?php echo e(asset('storage/' . $attachment->file_path)); ?>" alt="<?php echo e($attachment->file_name); ?>" class="max-h-48 rounded-lg object-cover group-hover:opacity-90 transition-opacity">
                                                </div>
                                            <?php elseif($isAudio): ?>
                                                <div class="bg-slate-100 dark:bg-gray-600 px-3 py-2 rounded-lg flex items-center gap-2">
                                                    ...
                                                    <a href="<?php echo e(asset('storage/' . $attachment->file_path)); ?>" target="_blank" class="text-sm font-medium truncate text-blue-600 dark:text-blue-400 hover:underline"><?php echo e($attachment->file_name); ?></a>
                                                </div>
                                            <?php else: ?>
                                                <div class="bg-slate-100 dark:bg-gray-600 px-3 py-2 rounded-lg flex items-center gap-2">
...
<script>
    ...
    function subscribeToRealtimeUpdates() {
        ...
        console.log('Echo driver:', '<?php echo e(config("broadcasting.default")); ?>');
