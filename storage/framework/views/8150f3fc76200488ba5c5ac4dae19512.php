...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.black-button','data' => ['href' => ''.e(route('admin.jobs.create')).'','class' => 'w-full sm:w-auto']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('admin.jobs.create')).'','class' => 'w-full sm:w-auto']); ?>
                ...
                <div class="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-5 hover:shadow-lg hover:scale-105 transition-all duration-300">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-black dark:text-white mt-1"><?php echo e($jobs->total()); ?></p>
                        </div>
                ...
                <div class="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-green-200 dark:border-green-800/50 p-4 sm:p-5 hover:shadow-lg hover:shadow-green-100 dark:hover:shadow-green-900/20 hover:scale-105 transition-all duration-300">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-green-600 dark:text-green-400 mt-1"><?php echo e($jobs->where('status', 'published')->count()); ?></p>
                        </div>
                ...
                <div class="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-yellow-200 dark:border-yellow-800/50 p-4 sm:p-5 hover:shadow-lg hover:shadow-yellow-100 dark:hover:shadow-yellow-900/20 hover:scale-105 transition-all duration-300">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-yellow-600 dark:text-yellow-400 mt-1"><?php echo e($jobs->where('status', 'draft')->count()); ?></p>
                        </div>
                ...
                <div class="group bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-5 hover:shadow-lg hover:scale-105 transition-all duration-300">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-gray-600 dark:text-gray-400 mt-1"><?php echo e($jobs->where('status', 'closed')->count()); ?></p>
                        </div>
...
<?php endif; ?>
                        <?php if(request()->hasAny(['search', 'status'])): ?>
                            <?php if (isset($component)) { $__componentOriginaldf9bc64087ea57ded106e8b72ce8d783 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldf9bc64087ea57ded106e8b72ce8d783 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.black-button','data' => ['variant' => 'outline','href' => ''.e(route('admin.jobs.index')).'','class' => 'flex-1 sm:flex-initial justify-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('black-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','href' => ''.e(route('admin.jobs.index')).'','class' => 'flex-1 sm:flex-initial justify-center']); ?>
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"/>
                                </svg>
                            ...
                            <div class="flex flex-col lg:flex-row lg:items-center gap-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <a href="<?php echo e(route('admin.jobs.show', $job)); ?>" class="text-lg sm:text-xl font-bold text-black dark:text-white hover:text-gray-700 dark:hover:text-gray-300 transition-colors block truncate">
                                                <?php echo e($job->title); ?>

                                            </a>
                                            <?php if($job->department): ?>
                                                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1"><?php echo e($job->department); ?></p>
                                            <?php endif; ?>
                                ...
                                <div class="hidden lg:flex items-center gap-6">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="text-sm font-medium text-gray-700 dark:text-gray-300"><?php echo e($job->location ?? 'Remote'); ?></p>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <p class="text-sm font-medium text-gray-700 dark:text-gray-300"><?php echo e($job->created_at->format('M d, Y')); ?></p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center gap-2 pt-3 lg:pt-0 border-t lg:border-t-0 lg:border-l border-gray-200 dark:border-gray-700 lg:pl-6">
                                    <?php if (isset($component)) { $__componentOriginaldf9bc64087ea57ded106e8b72ce8d783 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldf9bc64087ea57ded106e8b72ce8d783 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.black-button','data' => ['variant' => 'outline','href' => ''.e(route('admin.jobs.show', $job)).'','class' => 'flex-1 lg:flex-initial']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('black-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline','href' => ''.e(route('admin.jobs.show', $job)).'','class' => 'flex-1 lg:flex-initial']); ?>
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php endif; ?>
                                    <?php if (isset($component)) { $__componentOriginaldf9bc64087ea57ded106e8b72ce8d783 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldf9bc64087ea57ded106e8b72ce8d783 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.black-button','data' => ['href' => ''.e(route('admin.jobs.edit', $job)).'','class' => 'flex-1 lg:flex-initial']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('black-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('admin.jobs.edit', $job)).'','class' => 'flex-1 lg:flex-initial']); ?>
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php endif; ?>
                            ...
                            <div class="flex items-center justify-between mt-4 pt-4 border-t border-gray-200 dark:border-gray-700 lg:hidden">
                                <div class="flex items-center gap-3">
                                    ...
                                    <?php endif; ?>
                                    <span class="text-xs text-gray-500 dark:text-gray-400"><?php echo e($job->created_at->format('M d, Y')); ?></span>
                                </div>
                                <span class="inline-flex items-center gap-1.5 px-3 py-1 text-sm font-bold rounded-md bg-black dark:bg-white text-white dark:text-black">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
