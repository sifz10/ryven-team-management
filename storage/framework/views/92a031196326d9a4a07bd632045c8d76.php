                        ...
                        initEditors() {
                            setTimeout(() => {
                                ...
                                if (this.$refs.descriptionEditor && !this.descriptionEditor) {
                                    ...
                                    const descContent = `<?php echo addslashes($testCase->description ?? '<p><br></p>'); ?>`;
                                ...
                                if (this.$refs.stepsEditor && !this.stepsEditor) {
                                    ...
                                    const stepsContent = `<?php echo addslashes($testCase->steps ?? '<p><br></p>'); ?>`;
                                ...
                                if (this.$refs.expectedResultEditor && !this.expectedResultEditor) {
                                    ...
                                    const resultContent = `<?php echo addslashes($testCase->expected_result ?? '<p><br></p>'); ?>`;
                    ...
                    <div class="p-8 space-y-8">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            <div class="lg:col-span-2">
                                ...
                                <input type="text" name="title" value="<?php echo e(old('title', $testCase->title)); ?>" required 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <select name="priority" required 
                                    class="block w-full px-4 py-3.5 rounded-xl border-2 border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white transition-all text-base shadow-sm">
                                    <option value="low" <?php echo e(old('priority', $testCase->priority) === 'low' ? 'selected' : ''); ?>>🟢 Low</option>
                                    <option value="medium" <?php echo e(old('priority', $testCase->priority) === 'medium' ? 'selected' : ''); ?>>🟡 Medium</option>
                                    <option value="high" <?php echo e(old('priority', $testCase->priority) === 'high' ? 'selected' : ''); ?>>🟠 High</option>
                                    <option value="critical" <?php echo e(old('priority', $testCase->priority) === 'critical' ? 'selected' : ''); ?>>🔴 Critical</option>
                                </select>
...
<?php endif; ?>
<?php /**PATH F:\Project\salary\resources\views/uat/edit-test-case.blade.php ENDPATH**/ ?>