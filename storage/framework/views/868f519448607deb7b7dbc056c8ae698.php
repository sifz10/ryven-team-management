     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                ...
                <?php if(!$employee->discontinued_at): ?>
                    <form method="POST" action="<?php echo e(route('employees.discontinue', $employee)); ?>" id="discontinue-form">
                        <?php echo csrf_field(); ?>
                        <button type="button"
            ...
            <div x-show="openAdjustmentModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm overflow-y-auto p-4 sm:p-0" @click.self="openAdjustmentModal = false" x-transition:enter="ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-2xl transform transition-all my-auto" x-transition:enter="ease-out duration-200" x-transition:enter-start="scale-95 opacity-0" x-transition:enter-end="scale-100 opacity-100">
                    ...
                    <form @submit.prevent="submitAdjustment()" x-data="{
                        ...
                        newSalary: <?php echo e($employee->salary ?? 0); ?>,
                        reason: '',
                        submitting: false,
                        currentSalary: <?php echo e($employee->salary ?? 0); ?>,
                        difference: 0,
                        ...
                        async submitAdjustment() {
                            ...
                            try {
                                const response = await fetch('<?php echo e(route('employees.adjust-salary', $employee)); ?>', {
                                    method: 'POST',
                                    headers: {
                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-900/10 border border-blue-200 dark:border-blue-800 rounded-xl p-4 sm:p-6">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                <div>
                                    ...
                                    <p class="text-3xl sm:text-4xl font-bold text-blue-900 dark:text-blue-100"><?php echo e(number_format($employee->salary ?? 0, 2)); ?></p>
                                </div>
                                <div class="text-right">
                                    <p class="text-xs font-semibold text-blue-700 dark:text-blue-300 uppercase tracking-wide mb-1">Currency</p>
                                    <p class="text-xl sm:text-2xl font-bold text-blue-900 dark:text-blue-100"><?php echo e($employee->currency ?? 'USD'); ?></p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div x-show="difference !== 0" x-cloak class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 border-2 border-blue-200 dark:border-blue-800 rounded-lg p-4 sm:p-5">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <div class="text-xs font-semibold text-gray-600 dark:text-gray-400"><?php echo e($employee->currency ?? 'USD'); ?></div>
                                    </div>
                                </div>
                            </div>
...
<?php endif; ?>
                ...
                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex items-center gap-2">
                            <a href="<?php echo e(route('employees.salary-history', $employee)); ?>" class="inline-flex items-center gap-2 px-3 py-2 text-xs font-medium bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/50 transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                                </svg>
                                History
                            ...
                            <li class="border border-gray-200 dark:border-gray-700 rounded-xl p-4">
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form method="POST" action="<?php echo e(route('employees.bank-accounts.destroy', [$employee, $account])); ?>" id="delete-account-<?php echo e($account->id); ?>">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="button"
                                                    @click="$dispatch('open-delete-modal', { id: 'deleteAccountModal', form: document.getElementById('delete-account-<?php echo e($account->id); ?>') })"
                            ...
                            <li class="border border-gray-200 dark:border-gray-700 rounded-xl p-4">
                                <div class="flex items-start justify-between gap-3">
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <form method="POST" action="<?php echo e(route('employees.accesses.destroy', [$employee, $access])); ?>" id="delete-access-<?php echo e($access->id); ?>">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
                                            <button type="button"
                                                    @click="$dispatch('open-delete-modal', { id: 'deleteAccessModal', form: document.getElementById('delete-access-<?php echo e($access->id); ?>') })"
                                                    class="text-red-600 text-sm hover:text-red-700 transition">
                                                Delete
                                            </button>
                                        </form>
                                    ...
                                    <div class="bg-white dark:bg-gray-800/60 backdrop-blur-sm border <?php echo e($borderColor); ?> rounded-xl p-4 shadow-sm hover:shadow-md dark:hover:shadow-xl transition-all duration-200">
                                        ...
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <form method="POST" action="<?php echo e(route('employees.payments.destroy', [$employee, $payment])); ?>?tab=timeline" id="delete-payment-<?php echo e($payment->id); ?>" class="inline">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                    <button type="button"
                                                            @click="$dispatch('open-delete-modal', { id: 'deletePaymentModal', form: document.getElementById('delete-payment-<?php echo e($payment->id); ?>') })"
                                    ...
                                    <div class="p-6">
                                        <div class="flex items-start justify-between mb-4">
                                            ...
                                            <div class="flex items-center gap-2">
                                                ...
                                                <form method="POST" action="<?php echo e(route('employees.checklists.templates.destroy', [$employee, $template])); ?>" id="delete-template-<?php echo e($template->id); ?>" class="inline">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="button"
                                                            @click="$dispatch('open-delete-modal', { id: 'deleteTemplateModal', form: document.getElementById('delete-template-<?php echo e($template->id); ?>') })"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-modal','data' => ['id' => 'discontinueModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'discontinueModal']); ?>
         <?php $__env->slot('title', null, []); ?> Discontinue Employee <?php $__env->endSlot(); ?>
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginalb7eac87efb73c0c2c26fe03ec80faafd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb7eac87efb73c0c2c26fe03ec80faafd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-modal','data' => ['id' => 'deleteAccountModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('delete-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'deleteAccountModal']); ?>
         <?php $__env->slot('title', null, []); ?> Remove Bank Account <?php $__env->endSlot(); ?>
         <?php $__env->slot('message', null, []); ?> 
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginalb7eac87efb73c0c2c26fe03ec80faafd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb7eac87efb73c0c2c26fe03ec80faafd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-modal','data' => ['id' => 'deleteAccessModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('delete-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'deleteAccessModal']); ?>
         <?php $__env->slot('title', null, []); ?> Remove Access <?php $__env->endSlot(); ?>
         <?php $__env->slot('message', null, []); ?> 
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginalb7eac87efb73c0c2c26fe03ec80faafd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb7eac87efb73c0c2c26fe03ec80faafd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-modal','data' => ['id' => 'deletePaymentModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('delete-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'deletePaymentModal']); ?>
         <?php $__env->slot('title', null, []); ?> Delete Payment Entry <?php $__env->endSlot(); ?>
         <?php $__env->slot('message', null, []); ?> 
...
<?php endif; ?>
    ...
    <?php if (isset($component)) { $__componentOriginalb7eac87efb73c0c2c26fe03ec80faafd = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb7eac87efb73c0c2c26fe03ec80faafd = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-modal','data' => ['id' => 'deleteTemplateModal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('delete-modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'deleteTemplateModal']); ?>
         <?php $__env->slot('title', null, []); ?> Delete Checklist Template <?php $__env->endSlot(); ?>
         <?php $__env->slot('message', null, []); ?> 
...
<?php endif; ?>
<?php /**PATH D:\Ryven Works\ryven-team-management\resources\views/employees/show.blade.php ENDPATH**/ ?>