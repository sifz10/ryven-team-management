            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm rounded-2xl">
                <div class="p-8">
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="text-gray-700 dark:text-gray-300 mb-2">
                                        <span class="font-medium">Time:</span> <?php echo e($note->reminder_time->format('M d, Y h:i A')); ?>
                                    ...
                                    <?php if($note->recipients->count() > 0): ?>
                                        ...
                                        <ul class="mt-2 space-y-1">
                                            <?php $__currentLoopData = $note->recipients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recipient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="text-sm text-gray-600 dark:text-gray-400">• <?php echo e($recipient->email); ?></li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                    <?php endif; ?>
                                    <?php if($note->reminder_sent): ?>
                    ...
                    <div class="pt-6 border-t border-gray-200 dark:border-gray-700 text-sm text-gray-500 dark:text-gray-400">
                        <p>Created: <?php echo e($note->created_at->format('M d, Y h:i A')); ?></p>
                        <?php if($note->updated_at != $note->created_at): ?>
                            <p>Last updated: <?php echo e($note->updated_at->format('M d, Y h:i A')); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH F:\Project\salary\resources\views/notes/show.blade.php ENDPATH**/ ?>