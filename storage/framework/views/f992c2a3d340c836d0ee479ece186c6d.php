        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6" x-data="{
                ...
                loadFiles() {
                    ...
                    fetch(`/client/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/files`)
                ...
                loadComments() {
                    ...
                    fetch(`/client/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/comments`)
                        .then(response => response.json())
                        .then(data => {
                ...
                loadReminders() {
                    ...
                    fetch(`/client/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/reminders`)
                        .then(response => response.json())
                        .then(data => {
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div class="space-y-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <?php if($project->tasks->count() > 0): ?>
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7 gap-4">
                                    ...
                                    <?php $__currentLoopData = $kanbanStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $config): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                                        ...
                                        <div class="space-y-3 min-h-[200px]">
                                            ...
                                            <a href="<?php echo e(route('client.projects.tasks.show', [$project, $task])); ?>" class="block bg-white dark:bg-gray-800 rounded-lg p-3 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow duration-200">
                                                <!-- Task Title -->
                                                <h4 class="font-semibold text-sm text-gray-900 dark:text-white mb-2 line-clamp-2"><?php echo strip_tags($task->title); ?></h4>

                                                <!-- Description -->
                                                <?php if($task->description): ?>
                                                    <p class="text-xs text-gray-500 dark:text-gray-400 mb-3 line-clamp-2"><?php echo Str::limit(strip_tags($task->description), 100); ?></p>
                                                <?php endif; ?>

                                                <!-- Tags -->
                                                <?php if($task->tags && $task->tags->count() > 0): ?>
                                                <div class="flex flex-wrap gap-1.5 mb-3">
                                                    ...
                                                    <span class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold shadow-sm transition-all hover:shadow-md"
                                                          style="background: linear-gradient(135deg, <?php echo e($tag->color); ?>15 0%, <?php echo e($tag->color); ?>25 100%);
                                                                 color: <?php echo e($tag->color); ?>;
                                                                 border: 1.5px solid <?php echo e($tag->color); ?>50;
                                                                 box-shadow: 0 1px 2px <?php echo e($tag->color); ?>15;">
                                                        <?php echo e($tag->name); ?>
                                                ...
                                                <!-- Progress Bar -->
                                                <?php if($task->checklists && $task->checklists->count() > 0): ?>
                                                <?php
                                                ...
                                                <div class="flex items-center gap-2 mb-3">
                                                    ...
                                                    <span class="text-xs text-gray-600 dark:text-gray-400"><?php echo e($completedItems); ?>/<?php echo e($totalItems); ?></span>
                                                </div>
                                                <?php endif; ?>
                                                ...
                                                <div class="flex items-center justify-between pt-3 border-t border-gray-100 dark:border-gray-700">
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium
                                                            <?php if($task->priority === 'critical'): ?> bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400
                                                            <?php elseif($task->priority === 'high'): ?> bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400
                                                            <?php elseif($task->priority === 'medium'): ?> bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400
                                                        ...
                                                        <div class="flex items-center gap-1 text-xs <?php echo e(\Carbon\Carbon::parse($task->due_date)->isPast() && $task->status !== 'completed' ? 'text-red-600 dark:text-red-400 font-semibold' : 'text-gray-500 dark:text-gray-400'); ?>">
                                                            <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                                            </svg>
                                                            <span><?php echo e(\Carbon\Carbon::parse($task->due_date)->format('M d')); ?></span>
                                                        </div>
                                                        <?php endif; ?>
                                                    </div>
                                                    ...
                                                    <div class="w-6 h-6 bg-gradient-to-br from-indigo-500 to-purple-600 text-white rounded-full flex items-center justify-center text-xs font-semibold ring-2 ring-white dark:ring-gray-800"
                                                         title="<?php echo e($task->assignee->first_name ?? ''); ?> <?php echo e($task->assignee->last_name ?? ''); ?>">
                    ...
                    <div x-show="activeTab === 'files'" x-cloak>
                        ...
                        <div x-data="{
                            files: <?php echo e($filesData->toJson()); ?>,
                            filteredFiles: <?php echo e($filesData->toJson()); ?>,
                            searchQuery: '',
                            ...
                            async submitFiles() {
                                ...
                                try {
                                    const response = await fetch('<?php echo e(route("client.projects.files.store", $project)); ?>', {
                                        method: 'POST',
                                        body: formData
                                    });
                            ...
                            async deleteFile() {
                                ...
                                try {
                                    const response = await fetch('<?php echo e(route("client.projects.files.destroy", [$project, "FILE_ID"])); ?>'.replace('FILE_ID', this.fileToDelete.id), {
                                        method: 'DELETE',
                                        headers: {
