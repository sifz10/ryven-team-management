...
<aside
    ...
    <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
        ...
        <?php if(Auth::guard('web')->check()): ?>
            ...
            <?php if(auth()->user()->hasPermission('view-employees')): ?>
            ...
            <?php if(auth()->user()->hasPermission('view-attendance')): ?>
        ...
        <!-- UAT -->
        <?php if(auth()->user()->hasPermission('view-uat-projects')): ?>
        ...
        <!-- GitHub Logs -->
        <?php if(auth()->user()->hasPermission('view-github-logs')): ?>
        ...
        <!-- Invoices -->
        <?php if(auth()->user()->hasPermission('view-invoices')): ?>
        ...
        <!-- Contracts -->
        <?php if(auth()->user()->hasPermission('view-contracts')): ?>
        ...
        <!-- Personal Notes -->
        <?php if(auth()->user()->hasPermission('view-notes')): ?>
        ...
        <!-- Review Cycles -->
        <?php if(auth()->user()->hasPermission('view-review-cycles')): ?>
        ...
        <!-- Performance Reviews -->
        <?php if(auth()->user()->hasPermission('view-reviews')): ?>
        ...
        <!-- Goals & OKRs -->
        <?php if(auth()->user()->hasPermission('view-goals')): ?>
        ...
        <?php endif; ?>
            ...
            <!-- Skills -->
            <?php if(auth()->user()->hasPermission('view-skills')): ?>
