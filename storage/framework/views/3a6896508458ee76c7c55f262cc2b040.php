...
unset($__errorArgs, $__bag); ?>">
                        <option value="1" <?php echo e(old('priority') == 1 ? 'selected' : ''); ?>>🔴 Critical</option>
                        <option value="2" <?php echo e(old('priority', 2) == 2 ? 'selected' : ''); ?>>🟠 High</option>
                        <option value="3" <?php echo e(old('priority') == 3 ? 'selected' : ''); ?>>🟡 Medium</option>
                        <option value="4" <?php echo e(old('priority') == 4 ? 'selected' : ''); ?>>🟢 Low</option>
                    </select>
