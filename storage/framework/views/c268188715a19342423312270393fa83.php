...
<head>
    ...
    <title><?php echo e($test->test_title); ?> - Submit Your Test</title>
...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
    <div class="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div class="text-center mb-8 fade-in">
            ...
            <h1 class="text-3xl font-bold text-gray-900 mb-2"><?php echo e($test->test_title); ?></h1>
            <p class="text-gray-600">Test Assignment for <?php echo e($test->application->jobPost->title); ?></p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-6 fade-in border border-gray-200">
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900"><?php echo e($test->application->full_name); ?></h3>
                    <p class="text-gray-600 text-sm"><?php echo e($test->application->email); ?></p>
                </div>
            </div>
            ...
            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-lg">
                <div class="flex items-start">
                    ...
                    <div>
                        ...
                        <p class="text-yellow-700 text-sm mt-1"><?php echo e($test->deadline->format('F j, Y \a\t g:i A')); ?></p>
                        <p class="text-yellow-600 text-xs mt-1"><?php echo e($test->deadline->diffForHumans()); ?></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-6 fade-in border border-gray-200">
            ...
            <?php if($test->test_description): ?>
                <div class="mb-4">
                    ...
                    <p class="text-gray-600 leading-relaxed"><?php echo e($test->test_description); ?></p>
                </div>
            <?php endif; ?>

            <?php if($test->test_instructions): ?>
                <div class="mb-4">
                    <h3 class="text-sm font-semibold text-gray-700 mb-2">Instructions</h3>
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <p class="text-blue-900 text-sm leading-relaxed whitespace-pre-wrap"><?php echo e($test->test_instructions); ?></p>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if($test->test_file_path): ?>
                <div class="mt-4">
                    <a href="<?php echo e(route('test.submission.download', $test->submission_token)); ?>"
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-6 fade-in border border-gray-200" x-data="fileUpload()">
            ...
            <form action="<?php echo e(route('test.submission.submit', $test->submission_token)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6" @submit="handleSubmit">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea name="submission_notes" rows="4"
                              ...
                              placeholder="Add any comments, explanations, or notes about your submission..."><?php echo e(old('submission_notes')); ?></textarea>
                    <?php $__errorArgs = ['submission_notes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH F:\Project\salary\resources\views/test-submission/show.blade.php ENDPATH**/ ?>