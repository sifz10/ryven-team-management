    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm rounded-2xl">
                <form action="<?php echo e(route('invoices.update', $invoice)); ?>" method="POST" x-data="invoiceForm()">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="date" name="invoice_date" x-model="invoiceDate" 
                                    value="<?php echo e(old('invoice_date', $invoice->invoice_date->format('Y-m-d'))); ?>"
                                    class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500" 
                                    required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="currency" x-model="currency"
                                ...
                                required>
                                <option value="USD" <?php echo e($invoice->currency === 'USD' ? 'selected' : ''); ?>>USD - US Dollar</option>
                                <option value="EUR" <?php echo e($invoice->currency === 'EUR' ? 'selected' : ''); ?>>EUR - Euro</option>
                                <option value="GBP" <?php echo e($invoice->currency === 'GBP' ? 'selected' : ''); ?>>GBP - British Pound</option>
                                <option value="CAD" <?php echo e($invoice->currency === 'CAD' ? 'selected' : ''); ?>>CAD - Canadian Dollar</option>
                                <option value="AUD" <?php echo e($invoice->currency === 'AUD' ? 'selected' : ''); ?>>AUD - Australian Dollar</option>
                            </select>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="client_name" 
                                        ...
                                        value="<?php echo e(old('client_name', $invoice->client_name)); ?>"
                                        class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500" 
                                        required>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <input type="email" name="client_email" 
                                        value="<?php echo e(old('client_email', $invoice->client_email)); ?>"
                                        class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div>
                                    ...
                                    <textarea name="client_address" rows="3"
                                        class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500"><?php echo e(old('client_address', $invoice->client_address)); ?></textarea>
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <textarea name="notes" rows="4"
                                    class="w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-blue-500 focus:ring-blue-500"
                                    placeholder="Additional notes or instructions..."><?php echo e(old('notes', $invoice->notes)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea name="terms" rows="8"
                                    ...
                                    placeholder="Payment terms and conditions..."><?php echo e(old('terms', $invoice->terms)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
    ...
    <script>
        function invoiceForm() {
            return {
                invoiceDate: '<?php echo e(old("invoice_date", $invoice->invoice_date->format("Y-m-d"))); ?>',
                dueDate: '<?php echo e(old("due_date", $invoice->due_date->format("Y-m-d"))); ?>',
                currency: '<?php echo e(old("currency", $invoice->currency)); ?>',
                items: <?php echo json_encode(old('items', $invoice->items), 512) ?>,
                taxPercentage: <?php echo e(old('tax_percentage', $invoice->tax_percentage)); ?>,
                discountPercentage: <?php echo e(old('discount_percentage', $invoice->discount_percentage)); ?>,
                subtotal: 0,
                taxAmount: 0,
                discountAmount: 0,
                total: 0,
...
<?php /**PATH F:\Project\salary\resources\views/invoices/edit.blade.php ENDPATH**/ ?>