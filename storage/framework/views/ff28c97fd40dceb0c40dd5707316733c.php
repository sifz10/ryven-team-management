    ...
    Alpine.data('taskManager', () => ({
        ...
        saveReminder() {
            ...
            const url = this.editingReminder
                ? `/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/reminders/${this.editingReminder.id}`
                : `/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/reminders`;
        ...
        deleteReminder(reminderId) {
            ...
            fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/reminders/${reminderId}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                }
