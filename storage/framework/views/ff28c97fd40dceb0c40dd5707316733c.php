                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            ...
                            <?php if($task->assignee): ?>
                                <div class="inline-flex items-center gap-2.5 px-3 h-10 bg-gradient-to-r from-gray-900 to-black rounded-xl shadow-lg">
                                    ...
                                    <span class="text-xs font-bold text-white"><?php echo e($task->assignee->first_name); ?> <?php echo e($task->assignee->last_name); ?></span>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($task->due_date): ?>
                                <div class="inline-flex items-center gap-2.5 px-4 h-10 bg-gradient-to-r from-gray-900 to-black rounded-xl shadow-lg">
                                    ...
                                    <span class="text-xs font-bold text-white"><?php echo e($task->due_date->format('M d, Y')); ?></span>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($task->checklists->count() > 0): ?>
                                ...
                                <div class="inline-flex items-center gap-2.5 px-4 h-10 bg-gradient-to-r from-gray-900 to-black rounded-xl shadow-lg">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <span class="text-xs font-bold text-white"><?php echo e($completed); ?>/<?php echo e($total); ?></span>
                                        <div class="w-12 h-1.5 bg-white/20 rounded-full overflow-hidden">
                                            <div class="h-full bg-white rounded-full transition-all duration-300" style="width: <?php echo e($percentage); ?>%"></div>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
...
document.addEventListener('alpine:init', () => {
    Alpine.data('taskManager', () => ({
        ...
        async confirmDeleteFile() {
            ...
            try {
                const response = await fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/files/${this.deletingFileId}`, {
                    method: 'DELETE',
                    headers: {
                        'X-CSRF-TOKEN': document.querySelector('meta[name=csrf-token]').getAttribute('content')
                    }
        ...
        async confirmDeleteComment() {
            ...
            try {
                const response = await fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/comments/${this.deletingCommentId}`, {
                    method: 'DELETE',
                    headers: {
                        'Content-Type': 'application/json',
