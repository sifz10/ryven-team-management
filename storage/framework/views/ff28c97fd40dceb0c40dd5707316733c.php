    ...
    <div class="relative">
        <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            ...
            <div class="flex items-center gap-3 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-2 shadow-sm border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-sm">
                <a
                    href="<?php echo e(route('projects.show', ['project' => $project->id, 'tab' => 'tasks', 'sub_tab' => 'list'])); ?>"
                ...
                <a
                    href="<?php echo e(route('projects.show', ['project' => $project->id, 'tab' => 'tasks', 'sub_tab' => 'kanban'])); ?>"
    ...
    <div x-show="view === 'list'"
        ...
        <?php if($project->tasks->count() > 0): ?>
            <div class="space-y-4">
                ...
                <div @click="viewTaskDetail(<?php echo \Illuminate\Support\Js::from($task->toArray())->toHtml() ?>)"
                    ...
                    <div class="relative p-7">
                        <div class="flex items-start justify-between gap-6 mb-5">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-3 mb-3">
                                    <h3 class="text-xl font-extrabold text-gray-900 dark:text-white group-hover:text-black dark:group-hover:text-white transition-colors flex-1"><?php echo $task->title; ?></h3>
                                </div>
                                <?php if($task->description): ?>
                                    <p class="text-sm leading-relaxed text-gray-600 dark:text-gray-400 line-clamp-2"><?php echo Str::limit(strip_tags($task->description), 180); ?></p>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-x-2 group-hover:translate-x-0">
                                <button @click.stop="openTaskModal(<?php echo \Illuminate\Support\Js::from($task->toArray())->toHtml() ?>)"
                                ...
                                <form action="<?php echo e(route('projects.tasks.destroy', [$project, $task])); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this task?')" @click.stop>
                                    <?php echo csrf_field(); ?>
                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            ...
                            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-extrabold shadow-sm
                                <?php if($task->status === 'completed'): ?> bg-gradient-to-r from-green-500 to-emerald-600 text-white
                                <?php elseif($task->status === 'live'): ?> bg-gradient-to-r from-indigo-500 to-blue-600 text-white
                                <?php elseif($task->status === 'staging'): ?> bg-gradient-to-r from-purple-500 to-violet-600 text-white
                                <?php elseif($task->status === 'awaiting-feedback'): ?> bg-gradient-to-r from-orange-500 to-amber-600 text-white
                                <?php elseif($task->status === 'in-progress'): ?> bg-gradient-to-r from-blue-500 to-cyan-600 text-white
                                <?php elseif($task->status === 'on-hold'): ?> bg-gradient-to-r from-yellow-500 to-yellow-600 text-white
                                <?php else: ?> bg-gradient-to-r from-gray-500 to-slate-600 text-white <?php endif; ?>">
                                <?php if($task->status === 'completed'): ?>
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                <?php elseif($task->status === 'live'): ?>
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                <?php elseif($task->status === 'staging'): ?>
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5-1.429A1 1 0 009 15.571V11a1 1 0 112 0v4.571a1 1 0 00.725.962l5 1.428a1 1 0 001.17-1.408l-7-14z"></path>
                                    </svg>
                                <?php elseif($task->status === 'awaiting-feedback'): ?>
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <?php endif; ?>
                                <span class="uppercase tracking-wider"><?php echo e(ucfirst(str_replace('-', ' ', $task->status))); ?></span>
                            </div>
                            ...
                            <div class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-extrabold border-2 backdrop-blur-sm
                                <?php if($task->priority === 4): ?> bg-red-50/80 border-red-300 text-red-900 dark:bg-red-900/20 dark:border-red-700 dark:text-red-300
                                <?php elseif($task->priority === 3): ?> bg-orange-50/80 border-orange-300 text-orange-900 dark:bg-orange-900/20 dark:border-orange-700 dark:text-orange-300
                                <?php elseif($task->priority === 2): ?> bg-blue-50/80 border-blue-300 text-blue-900 dark:bg-blue-900/20 dark:border-blue-700 dark:text-blue-300
                                <?php else: ?> bg-gray-50/80 border-gray-300 text-gray-900 dark:bg-gray-700/20 dark:border-gray-600 dark:text-gray-300 <?php endif; ?>">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM14 11a1 1 0 011 1v1h1a1 1 0 110 2h-1v1a1 1 0 11-2 0v-1h-1a1 1 0 110-2h1v-1a1 1 0 011-1z"></path>
                                </svg>
                                <span class="uppercase tracking-wider"><?php echo e($task->priority_label); ?></span>
                            </div>
                                ...
                                <div class="inline-flex items-center gap-2.5 px-4 py-2 bg-gradient-to-r from-gray-100 to-gray-50 dark:from-gray-700 dark:to-gray-800 rounded-xl border border-gray-200 dark:border-gray-600">
                                    <div class="w-7 h-7 rounded-full bg-gradient-to-br from-purple-600 via-pink-600 to-blue-600 p-0.5">
                                        <div class="w-full h-full rounded-full bg-gradient-to-br from-gray-900 to-black dark:from-gray-100 dark:to-white flex items-center justify-center text-white dark:text-black text-xs font-extrabold">
                                            <?php echo e(substr($task->assignee->first_name, 0, 1)); ?><?php echo e(substr($task->assignee->last_name, 0, 1)); ?>

                                        </div>
                                    </div>
                                    <span class="text-xs font-bold text-gray-900 dark:text-white"><?php echo e($task->assignee->first_name); ?> <?php echo e($task->assignee->last_name); ?></span>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($task->due_date): ?>
                                <div class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-amber-50 to-yellow-50 dark:from-amber-900/20 dark:to-yellow-900/20 border border-amber-200 dark:border-amber-800 rounded-xl">
                                    ...
                                    <span class="text-xs font-bold text-amber-900 dark:text-amber-300"><?php echo e($task->due_date->format('M d, Y')); ?></span>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($task->checklists->count() > 0): ?>
                                ...
                                <div class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-teal-50 to-cyan-50 dark:from-teal-900/20 dark:to-cyan-900/20 border border-teal-200 dark:border-teal-800 rounded-xl">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <span class="text-xs font-bold text-teal-900 dark:text-teal-300"><?php echo e($completed); ?>/<?php echo e($total); ?></span>
                                        <div class="w-12 h-1.5 bg-teal-200 dark:bg-teal-800 rounded-full overflow-hidden">
                                            <div class="h-full bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full transition-all duration-300" style="width: <?php echo e($percentage); ?>%"></div>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php if($task->tags->count() > 0): ?>
                                <div class="flex items-center gap-2 ml-auto">
                                    <?php $__currentLoopData = $task->tags->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="inline-flex items-center px-3 py-1.5 rounded-lg text-xs font-bold border bg-<?php echo e($tag->color); ?>-50/50 dark:bg-<?php echo e($tag->color); ?>-900/20 border-<?php echo e($tag->color); ?>-200 dark:border-<?php echo e($tag->color); ?>-800 text-<?php echo e($tag->color); ?>-900 dark:text-<?php echo e($tag->color); ?>-300 backdrop-blur-sm">
                                            <?php echo e($tag->name); ?>

                                        </span>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($task->tags->count() > 3): ?>
            ...
            <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $config): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-gray-50 dark:bg-gray-900/50 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-bold text-sm text-gray-900 dark:text-white"><?php echo e($config['label']); ?></h3>
                        <span class="inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-<?php echo e($config['color']); ?>-600 dark:text-<?php echo e($config['color']); ?>-400 bg-<?php echo e($config['color']); ?>-100 dark:bg-<?php echo e($config['color']); ?>-900/30 rounded-full">
                            <?php echo e($project->tasks->where('status', $status)->count()); ?>

                        </span>
                    </div>

                    <div class="kanban-column space-y-3 min-h-[200px]" data-status="<?php echo e($status); ?>">
                        <?php $__currentLoopData = $project->tasks->where('status', $status)->sortBy('order'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div @click="viewTaskDetail(<?php echo \Illuminate\Support\Js::from($task->toArray())->toHtml() ?>)" class="kanban-task bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700 cursor-pointer hover:shadow-lg transition-shadow"
                                 data-task-id="<?php echo e($task->id); ?>">
                                <h4 class="font-semibold text-sm text-gray-900 dark:text-white mb-2"><?php echo $task->title; ?></h4>

                                <?php if($task->description): ?>
                                    <div class="text-xs text-gray-600 dark:text-gray-400 mb-3 line-clamp-3"><?php echo Str::limit(strip_tags($task->description), 80); ?></div>
                                <?php endif; ?>
                                ...
                                <?php if($task->checklists->count() > 0): ?>
                                    <div class="flex items-center gap-2 mb-3 text-xs text-gray-600 dark:text-gray-400">
                                        ...
                                        <span><?php echo e($task->checklists->where('is_completed', true)->count()); ?>/<?php echo e($task->checklists->count()); ?></span>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if($task->tags->count() > 0): ?>
                                    <div class="flex flex-wrap gap-1 mb-3">
                                        <?php $__currentLoopData = $task->tags->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-<?php echo e($tag->color); ?>-100 dark:bg-<?php echo e($tag->color); ?>-900/30 text-<?php echo e($tag->color); ?>-800 dark:text-<?php echo e($tag->color); ?>-400">
                                                <?php echo e($tag->name); ?>

                                            </span>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($task->tags->count() > 2): ?>
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-semibold
                                        <?php if($task->priority === 'critical'): ?> bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400
                                        <?php elseif($task->priority === 'high'): ?> bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400
                                        <?php elseif($task->priority === 'medium'): ?> bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400
                                    ...
                                    <?php if($task->assignedTo): ?>
                                        <div class="w-6 h-6 rounded-full bg-gradient-to-br from-gray-800 to-black dark:from-gray-700 dark:to-gray-900 flex items-center justify-center text-white text-xs font-bold" title="<?php echo e($task->assignedTo->first_name); ?> <?php echo e($task->assignedTo->last_name); ?>">
                                            <?php echo e(substr($task->assignedTo->first_name, 0, 1)); ?><?php echo e(substr($task->assignedTo->last_name, 0, 1)); ?>
                        ...
                        <?php if($project->tasks->where('status', $status)->count() === 0): ?>
    ...
    <div x-show="showTaskModal"
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-2xl w-full p-6 border border-gray-200 dark:border-gray-700" @click.stop>
                ...
                <form :action="editingTask ? '<?php echo e(route('projects.tasks.update', [$project, '__TASK__'])); ?>'.replace('__TASK__', editingTask) : '<?php echo e(route('projects.tasks.store', $project)); ?>'" method="POST" class="space-y-4" @keydown.enter.prevent="$event.target.form && $event.target.tagName !== 'TEXTAREA' && $event.target.id !== 'task-description-editor' ? false : true">
                    <?php echo csrf_field(); ?>
                            ...
                            <template x-for="reminder in taskReminders" :key="reminder.id">
                                <div class="relative group bg-white dark:bg-gray-800 border-2 rounded-lg p-3 transition-all"
                                    ...
                                    <div class="flex items-start justify-between gap-3 pr-16">
                                        ...
                                        <div x-show="!reminder.is_sent && reminder.created_by.id === <?php echo e(auth()->user()->employee?->id ?? 'null'); ?>" class="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
...
document.addEventListener('alpine:init', () => {
    Alpine.data('taskManager', () => ({
        ...
        allTags: <?php echo json_encode(\App\Models\ProjectTaskTag::pluck('name')->toArray(), 15, 512) ?>,
        ...
        employees: [
            <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            {
                ...
                name: '<?php echo e($employee->first_name); ?> <?php echo e($employee->last_name); ?>',
                email: '<?php echo e($employee->email); ?>',
                initials: '<?php echo e(substr($employee->first_name, 0, 1)); ?><?php echo e(substr($employee->last_name, 0, 1)); ?>'
        ...
        saveChecklistItem(item) {
            ...
            fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/checklist`, {
                method: 'POST',
                headers: {
        ...
        uploadFile(file) {
            ...
            fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/files`, {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name=csrf-token]').getAttribute('content'),
        ...
        deleteFile(fileId) {
            ...
            fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/files/${fileId}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name=csrf-token]').getAttribute('content')
                }
        ...
        openFilePreview(file) {
            ...
            const downloadUrl = `/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/files/${file.id}/download`;
        ...
        loadFiles() {
            ...
            if (this.viewingTask.files && Array.isArray(this.viewingTask.files)) {
                this.taskFiles = this.viewingTask.files.map(file => ({
                    ...
                    download_url: `/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/files/${file.id}/download`
                }));
            } else {
                this.taskFiles = [];
            }
        ...
        loadComments() {
            ...
            fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/comments`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        handleCommentInput(event) {
            ...
            if (lastAtIndex !== -1) {
                ...
                if (!textAfterAt.includes(' ')) {
                    ...
                    fetch(`/projects/<?php echo e($project->id); ?>/employees/mention?search=${this.mentionSearch}`)
                        .then(response => response.json())
                        .then(data => {
                            if (data.success) {
        ...
        addReply(comment) {
            ...
            fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/comments/${comment.id}/replies`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name=csrf-token]').getAttribute('content')
        ...
        handleReplyInput(event, comment) {
            ...
            if (lastAtIndex !== -1) {
                ...
                if (!textAfterAt.includes(' ')) {
                    ...
                    // Fetch matching employees
                    fetch(`/projects/<?php echo e($project->id); ?>/employees/mention?search=${mentionSearch}`)
                        .then(response => response.json())
                        .then(data => {
                            if (data.success) {
        ...
        toggleReaction(commentId, reactionType) {
            ...
            fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/comments/${commentId}/reactions`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name=csrf-token]').getAttribute('content')
        ...
        hasUserReacted(comment, reactionType) {
            ...
            const currentEmployeeId = <?php echo e(auth()->user()->employee ? auth()->user()->employee->id : 'null'); ?>;
        ...
        loadReminders() {
            ...
            fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/reminders`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        loadReminderRecipients() {
            ...
            fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/reminder-recipients`)
                .then(response => response.json())
                .then(data => {
                    if (data.success) {
        ...
        saveReminder() {
            ...
            if (this.editingReminder) {
                ...
                fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/reminders/${this.editingReminder.id}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
            ...
            const promises = this.reminderForm.selectedRecipients.map(recipient => {
                ...
                return fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/reminders`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        confirmDeleteReminder() {
            ...
            fetch(`/projects/<?php echo e($project->id); ?>/tasks/${this.viewingTask.id}/reminders/${this.deletingReminderId}`, {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
                }
    ...
    columns.forEach(column => {
        new Sortable(column, {
            ...
            onEnd: function(evt) {
                ...
                fetch(`/projects/<?php echo e($project->id); ?>/tasks/${taskId}/move`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
...
<?php /**PATH F:\Project\salary\resources\views/projects/tabs/tasks.blade.php ENDPATH**/ ?>