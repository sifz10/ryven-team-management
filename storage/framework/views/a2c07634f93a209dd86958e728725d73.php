        ...
        <div class="bg-gradient-to-br from-gray-800 to-black dark:from-gray-900 dark:to-black rounded-xl p-6 border border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-white mt-2"><?php echo e(number_format($project->expenses->sum('amount'), 2)); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600 dark:text-green-400 mt-2"><?php echo e(number_format($project->expenses->where('status', 'approved')->sum('amount'), 2)); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-yellow-600 dark:text-yellow-400 mt-2"><?php echo e(number_format($project->expenses->where('status', 'pending')->sum('amount'), 2)); ?></p>
                </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-red-600 dark:text-red-400 mt-2"><?php echo e(number_format($project->expenses->where('status', 'rejected')->sum('amount'), 2)); ?></p>
                </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/30 transition-colors">
                        <td class="px-6 py-4">
                            <div>
                                <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($expense->title); ?></p>
                                <?php if($expense->description): ?>
                                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1"><?php echo e(Str::limit($expense->description, 60)); ?></p>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                                <?php if($expense->category === 'hosting'): ?> bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400
                                <?php elseif($expense->category === 'software'): ?> bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400
                                <?php elseif($expense->category === 'hardware'): ?> bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400
                                <?php elseif($expense->category === 'service'): ?> bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400
                        ...
                        <td class="px-6 py-4">
                            <p class="font-bold text-gray-900 dark:text-white"><?php echo e(number_format($expense->amount, 2)); ?></p>
                        </td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold
                                <?php if($expense->status === 'approved'): ?> bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400
                                <?php elseif($expense->status === 'pending'): ?> bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400
                        ...
                        <td class="px-6 py-4">
                            <span class="text-sm text-gray-900 dark:text-white"><?php echo e($expense->created_at->format('M d, Y')); ?></span>
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex items-center justify-end gap-2">
                                <?php if($expense->status === 'pending'): ?>
                                    <form action="<?php echo e(route('projects.expenses.update', [$project, $expense])); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
                                ...
                                <?php if($expense->receipt): ?>
                                    <a href="<?php echo e(Storage::url($expense->receipt)); ?>" target="_blank" class="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300" title="View Receipt">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <?php endif; ?>
                                <form action="<?php echo e(route('projects.expenses.destroy', [$project, $expense])); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this expense?')">
                                    <?php echo csrf_field(); ?>
    ...
    <div x-show="showExpenseModal"
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-2xl w-full p-6 border border-gray-200 dark:border-gray-700" @click.stop>
                ...
                <form action="<?php echo e(route('projects.expenses.store', $project)); ?>" method="POST" enctype="multipart/form-data" class="space-y-4">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH F:\Project\salary\resources\views/projects/tabs/finance.blade.php ENDPATH**/ ?>