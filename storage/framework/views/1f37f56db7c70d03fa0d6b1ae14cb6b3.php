...
<div x-data="{ show: false, form: null }"
     @open-delete-modal.window="if ($event.detail.id === '<?php echo e($id); ?>') { show = true; form = $event.detail.form; }"
     x-show="show"
     x-cloak
        ...
        <div x-show="show"
            ...
            <div class="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 p-6 text-center">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white">
                    <?php echo e($title ?? 'Confirm Delete'); ?>
            ...
            <div class="p-6">
                <p class="text-gray-600 dark:text-gray-300 text-center mb-6">
                    <?php echo e($message ?? 'Are you sure you want to delete this item? This action can be undone from the Deleted Users tab.'); ?>
...
<?php /**PATH D:\Ryven Works\ryven-team-management\resources\views/components/delete-modal.blade.php ENDPATH**/ ?>