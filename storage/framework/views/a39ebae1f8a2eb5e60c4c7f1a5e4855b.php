        ...
        <div class="max-w-7xl mx-auto text-center">
            ...
            <div class="flex flex-wrap items-center justify-center gap-3 mb-6 slide-in stagger-1">
                ...
                <?php if($job->experience_level): ?>
                    <span class="inline-flex items-center gap-2 px-4 py-2 bg-white/20 dark:bg-black/20 backdrop-blur-sm text-white dark:text-black rounded-full text-sm font-medium">
                        ...
                        <?php echo e(ucfirst($job->experience_level)); ?> Level
                    </span>
                <?php endif; ?>
            </div>
            <?php if($job->application_deadline): ?>
                <div class="flex items-center justify-center gap-2 text-sm text-white/90 dark:text-black/90 slide-in stagger-2">
                    ...
                    Apply before <?php echo e($job->application_deadline->format('F d, Y')); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-2xl border border-gray-100 dark:border-gray-700 p-6 md:p-8 sticky top-24 slide-in stagger-3">
                    ...
                    <form action="<?php echo e(route('jobs.apply', $job->slug)); ?>" method="POST" enctype="multipart/form-data" class="space-y-4" id="application-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="group">
                            ...
                            <input type="text" name="first_name" id="first_name" value="<?php echo e(old('first_name')); ?>" required
                                   placeholder="John"
                                   class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white transition-all duration-200 <?php $__errorArgs = ['first_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 dark:border-red-500 animate-shake <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="group">
                            ...
                            <input type="text" name="last_name" id="last_name" value="<?php echo e(old('last_name')); ?>" required
                                   placeholder="Doe"
                                   class="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white transition-all duration-200 <?php $__errorArgs = ['last_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 dark:border-red-500 animate-shake <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="group">
                            ...
                            <input type="email" name="email" id="email" value="<?php echo e(old('email')); ?>" required
                                   ...
                                   class="w-full px-4 py-3 border-2 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white transition-all duration-200 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="group">
                            ...
                            <input type="tel" name="phone" id="phone" value="<?php echo e(old('phone')); ?>" required
                                   ...
                                   class="w-full px-4 py-3 border-2 rounded-xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-black dark:focus:border-white transition-all duration-200 <?php $__errorArgs = ['phone'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 dark:border-red-500 animate-shake <?php else: ?> border-gray-300 dark:border-gray-600 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="group">
                            ...
                            <div class="relative border-2 border-dashed rounded-xl p-6 text-center hover:border-black dark:hover:border-white hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all duration-300 cursor-pointer <?php $__errorArgs = ['resume'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 dark:border-red-500 animate-shake <?php else: ?> border-gray-300 dark:border-gray-600 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <?php elseif($question->type === 'multiple_choice' && $question->options): ?>
                                                <div class="space-y-2 <?php $__errorArgs = ['answers.' . $question->id];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> animate-shake <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>">
    ...
    <footer class="bg-gradient-to-r from-gray-900 via-black to-gray-900 dark:from-gray-100 dark:via-white dark:to-gray-100 border-t border-gray-800 dark:border-gray-200 mt-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                <div class="flex items-center gap-3">
                    <img src="<?php echo e(asset('black-logo.png')); ?>" alt="Company Logo" class="h-10 w-auto invert dark:invert-0">
                </div>
...
<?php /**PATH F:\Project\salary\resources\views/jobs/show.blade.php ENDPATH**/ ?>