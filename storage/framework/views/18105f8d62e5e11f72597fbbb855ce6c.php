...
<?php $component->withAttributes([]); ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div>
                        ...
                        <select name="job_post_id" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-purple-500">
                            ...
                            <?php $__currentLoopData = $jobPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($job->id); ?>" <?php echo e($jobPostId == $job->id ? 'selected' : ''); ?>>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-6">
                ...
                <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6 text-white shadow-lg">
                    ...
                    <p class="text-4xl font-bold"><?php echo e($totalTests); ?></p>
                </div>
                ...
                <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-6 text-white shadow-lg">
                    ...
                    <p class="text-4xl font-bold"><?php echo e($completionRate); ?>%</p>
                    <p class="text-green-100 text-xs mt-1"><?php echo e($submittedTests); ?> / <?php echo e($totalTests); ?> submitted</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-xl p-6 text-white shadow-lg">
                    ...
                    <p class="text-4xl font-bold"><?php echo e($avgTimeToSubmit); ?></p>
                ...
                <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl p-6 text-white shadow-lg">
                    ...
                    <p class="text-4xl font-bold"><?php echo e($avgScore); ?></p>
                ...
                <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-xl p-6 text-white shadow-lg">
                    ...
                    <p class="text-4xl font-bold"><?php echo e($overdueTests); ?></p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="space-y-3">
                        <?php $__empty_1 = true; $__currentLoopData = $topCandidates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                ...
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-gray-900 dark:text-white truncate"><?php echo e($test->application->full_name); ?></p>
                                    <p class="text-xs text-gray-600 dark:text-gray-400 truncate"><?php echo e($test->test_title); ?></p>
                                </div>
                                <div class="text-right">
                                    <p class="font-bold text-lg text-purple-600 dark:text-purple-400"><?php echo e($test->score); ?></p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="space-y-3">
                        <?php $__empty_1 = true; $__currentLoopData = $testsByJob; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex items-center gap-3">
                                <div class="flex-1 min-w-0">
                                    <p class="font-medium text-gray-900 dark:text-white truncate"><?php echo e($job->title); ?></p>
                                </div>
                                <div class="flex items-center gap-2">
                                    <div class="bg-blue-100 dark:bg-blue-900/30 h-2 rounded-full" style="width: <?php echo e(($job->total / $totalTests) * 100); ?>px"></div>
                                    <span class="font-semibold text-gray-900 dark:text-white"><?php echo e($job->total); ?></span>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="space-y-3">
                        <form action="<?php echo e(route('admin.analytics.tests.export')); ?>" method="GET">
                            <input type="hidden" name="start_date" value="<?php echo e($startDate); ?>">
                            <input type="hidden" name="end_date" value="<?php echo e($endDate); ?>">
                            <?php if($jobPostId): ?>
                                <input type="hidden" name="job_post_id" value="<?php echo e($jobPostId); ?>">
                            <?php endif; ?>
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $recentTests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $test): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                <div class="w-10 h-10 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold">
                                    <?php echo e(substr($test->application->first_name, 0, 1)); ?><?php echo e(substr($test->application->last_name, 0, 1)); ?>

                                </div>
                                <div class="flex-1 min-w-0">
                                    <p class="font-semibold text-gray-900 dark:text-white"><?php echo e($test->application->full_name); ?></p>
                                    <p class="text-sm text-gray-600 dark:text-gray-400 truncate"><?php echo e($test->test_title); ?></p>
                                </div>
                                <div class="text-right">
                                    ...
                                    <?php endif; ?>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1"><?php echo e($test->sent_at->diffForHumans()); ?></p>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <script>
        ...
        new Chart(scoreCtx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [
                        <?php echo e($scoreDistribution['poor']); ?>,
                        <?php echo e($scoreDistribution['fair']); ?>,
                        <?php echo e($scoreDistribution['good']); ?>,
                        <?php echo e($scoreDistribution['excellent']); ?>
        ...
        new Chart(trendCtx, {
            type: 'line',
            data: {
                labels: <?php echo json_encode($dailyTrend->pluck('date')->map(function($date) {
                    return \Carbon\Carbon::parse($date)->format('M d');
                })); ?>,
                datasets: [{
                    label: 'Submissions',
                    data: <?php echo json_encode($dailyTrend->pluck('count')); ?>,
...
<?php endif; ?>
<?php /**PATH F:\Project\salary\resources\views/admin/analytics/tests.blade.php ENDPATH**/ ?>